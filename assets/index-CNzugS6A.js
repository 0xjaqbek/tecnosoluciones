 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var n_;function jx(){if(n_)return re;n_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(L){return L===null||typeof L!="object"?null:(L=v&&L[v]||L["@@iterator"],typeof L=="function"?L:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,C={};function y(L,tt,xt){this.props=L,this.context=tt,this.refs=C,this.updater=xt||M}y.prototype.isReactComponent={},y.prototype.setState=function(L,tt){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,tt,"setState")},y.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function _(){}_.prototype=y.prototype;function N(L,tt,xt){this.props=L,this.context=tt,this.refs=C,this.updater=xt||M}var D=N.prototype=new _;D.constructor=N,b(D,y.prototype),D.isPureReactComponent=!0;var A=Array.isArray,z={H:null,A:null,T:null,S:null,V:null},O=Object.prototype.hasOwnProperty;function F(L,tt,xt,yt,Q,mt){return xt=mt.ref,{$$typeof:o,type:L,key:tt,ref:xt!==void 0?xt:null,props:mt}}function X(L,tt){return F(L.type,tt,void 0,void 0,void 0,L.props)}function U(L){return typeof L=="object"&&L!==null&&L.$$typeof===o}function w(L){var tt={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(xt){return tt[xt]})}var G=/\/+/g;function lt(L,tt){return typeof L=="object"&&L!==null&&L.key!=null?w(""+L.key):tt.toString(36)}function ot(){}function vt(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(ot,ot):(L.status="pending",L.then(function(tt){L.status==="pending"&&(L.status="fulfilled",L.value=tt)},function(tt){L.status==="pending"&&(L.status="rejected",L.reason=tt)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function dt(L,tt,xt,yt,Q){var mt=typeof L;(mt==="undefined"||mt==="boolean")&&(L=null);var Mt=!1;if(L===null)Mt=!0;else switch(mt){case"bigint":case"string":case"number":Mt=!0;break;case"object":switch(L.$$typeof){case o:case t:Mt=!0;break;case g:return Mt=L._init,dt(Mt(L._payload),tt,xt,yt,Q)}}if(Mt)return Q=Q(L),Mt=yt===""?"."+lt(L,0):yt,A(Q)?(xt="",Mt!=null&&(xt=Mt.replace(G,"$&/")+"/"),dt(Q,tt,xt,"",function(oe){return oe})):Q!=null&&(U(Q)&&(Q=X(Q,xt+(Q.key==null||L&&L.key===Q.key?"":(""+Q.key).replace(G,"$&/")+"/")+Mt)),tt.push(Q)),1;Mt=0;var Rt=yt===""?".":yt+":";if(A(L))for(var Ct=0;Ct<L.length;Ct++)yt=L[Ct],mt=Rt+lt(yt,Ct),Mt+=dt(yt,tt,xt,mt,Q);else if(Ct=x(L),typeof Ct=="function")for(L=Ct.call(L),Ct=0;!(yt=L.next()).done;)yt=yt.value,mt=Rt+lt(yt,Ct++),Mt+=dt(yt,tt,xt,mt,Q);else if(mt==="object"){if(typeof L.then=="function")return dt(vt(L),tt,xt,yt,Q);throw tt=String(L),Error("Objects are not valid as a React child (found: "+(tt==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":tt)+"). If you meant to render a collection of children, use an array instead.")}return Mt}function I(L,tt,xt){if(L==null)return L;var yt=[],Q=0;return dt(L,yt,"","",function(mt){return tt.call(xt,mt,Q++)}),yt}function Z(L){if(L._status===-1){var tt=L._result;tt=tt(),tt.then(function(xt){(L._status===0||L._status===-1)&&(L._status=1,L._result=xt)},function(xt){(L._status===0||L._status===-1)&&(L._status=2,L._result=xt)}),L._status===-1&&(L._status=0,L._result=tt)}if(L._status===1)return L._result.default;throw L._result}var Y=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var tt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(tt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)};function Et(){}return re.Children={map:I,forEach:function(L,tt,xt){I(L,function(){tt.apply(this,arguments)},xt)},count:function(L){var tt=0;return I(L,function(){tt++}),tt},toArray:function(L){return I(L,function(tt){return tt})||[]},only:function(L){if(!U(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},re.Component=y,re.Fragment=i,re.Profiler=l,re.PureComponent=N,re.StrictMode=r,re.Suspense=m,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,re.__COMPILER_RUNTIME={__proto__:null,c:function(L){return z.H.useMemoCache(L)}},re.cache=function(L){return function(){return L.apply(null,arguments)}},re.cloneElement=function(L,tt,xt){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var yt=b({},L.props),Q=L.key,mt=void 0;if(tt!=null)for(Mt in tt.ref!==void 0&&(mt=void 0),tt.key!==void 0&&(Q=""+tt.key),tt)!O.call(tt,Mt)||Mt==="key"||Mt==="__self"||Mt==="__source"||Mt==="ref"&&tt.ref===void 0||(yt[Mt]=tt[Mt]);var Mt=arguments.length-2;if(Mt===1)yt.children=xt;else if(1<Mt){for(var Rt=Array(Mt),Ct=0;Ct<Mt;Ct++)Rt[Ct]=arguments[Ct+2];yt.children=Rt}return F(L.type,Q,void 0,void 0,mt,yt)},re.createContext=function(L){return L={$$typeof:h,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:u,_context:L},L},re.createElement=function(L,tt,xt){var yt,Q={},mt=null;if(tt!=null)for(yt in tt.key!==void 0&&(mt=""+tt.key),tt)O.call(tt,yt)&&yt!=="key"&&yt!=="__self"&&yt!=="__source"&&(Q[yt]=tt[yt]);var Mt=arguments.length-2;if(Mt===1)Q.children=xt;else if(1<Mt){for(var Rt=Array(Mt),Ct=0;Ct<Mt;Ct++)Rt[Ct]=arguments[Ct+2];Q.children=Rt}if(L&&L.defaultProps)for(yt in Mt=L.defaultProps,Mt)Q[yt]===void 0&&(Q[yt]=Mt[yt]);return F(L,mt,void 0,void 0,null,Q)},re.createRef=function(){return{current:null}},re.forwardRef=function(L){return{$$typeof:d,render:L}},re.isValidElement=U,re.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:Z}},re.memo=function(L,tt){return{$$typeof:p,type:L,compare:tt===void 0?null:tt}},re.startTransition=function(L){var tt=z.T,xt={};z.T=xt;try{var yt=L(),Q=z.S;Q!==null&&Q(xt,yt),typeof yt=="object"&&yt!==null&&typeof yt.then=="function"&&yt.then(Et,Y)}catch(mt){Y(mt)}finally{z.T=tt}},re.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},re.use=function(L){return z.H.use(L)},re.useActionState=function(L,tt,xt){return z.H.useActionState(L,tt,xt)},re.useCallback=function(L,tt){return z.H.useCallback(L,tt)},re.useContext=function(L){return z.H.useContext(L)},re.useDebugValue=function(){},re.useDeferredValue=function(L,tt){return z.H.useDeferredValue(L,tt)},re.useEffect=function(L,tt,xt){var yt=z.H;if(typeof xt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return yt.useEffect(L,tt)},re.useId=function(){return z.H.useId()},re.useImperativeHandle=function(L,tt,xt){return z.H.useImperativeHandle(L,tt,xt)},re.useInsertionEffect=function(L,tt){return z.H.useInsertionEffect(L,tt)},re.useLayoutEffect=function(L,tt){return z.H.useLayoutEffect(L,tt)},re.useMemo=function(L,tt){return z.H.useMemo(L,tt)},re.useOptimistic=function(L,tt){return z.H.useOptimistic(L,tt)},re.useReducer=function(L,tt,xt){return z.H.useReducer(L,tt,xt)},re.useRef=function(L){return z.H.useRef(L)},re.useState=function(L){return z.H.useState(L)},re.useSyncExternalStore=function(L,tt,xt){return z.H.useSyncExternalStore(L,tt,xt)},re.useTransition=function(){return z.H.useTransition()},re.version="19.1.0",re}var i_;function dd(){return i_||(i_=1,Hf.exports=jx()),Hf.exports}var vn=dd(),Gf={exports:{}},So={},Vf={exports:{}},kf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var a_;function Zx(){return a_||(a_=1,function(o){function t(I,Z){var Y=I.length;I.push(Z);t:for(;0<Y;){var Et=Y-1>>>1,L=I[Et];if(0<l(L,Z))I[Et]=Z,I[Y]=L,Y=Et;else break t}}function i(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var Z=I[0],Y=I.pop();if(Y!==Z){I[0]=Y;t:for(var Et=0,L=I.length,tt=L>>>1;Et<tt;){var xt=2*(Et+1)-1,yt=I[xt],Q=xt+1,mt=I[Q];if(0>l(yt,Y))Q<L&&0>l(mt,yt)?(I[Et]=mt,I[Q]=Y,Et=Q):(I[Et]=yt,I[xt]=Y,Et=xt);else if(Q<L&&0>l(mt,Y))I[Et]=mt,I[Q]=Y,Et=Q;else break t}}return Z}function l(I,Z){var Y=I.sortIndex-Z.sortIndex;return Y!==0?Y:I.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,v=null,x=3,M=!1,b=!1,C=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function A(I){for(var Z=i(p);Z!==null;){if(Z.callback===null)r(p);else if(Z.startTime<=I)r(p),Z.sortIndex=Z.expirationTime,t(m,Z);else break;Z=i(p)}}function z(I){if(C=!1,A(I),!b)if(i(m)!==null)b=!0,O||(O=!0,lt());else{var Z=i(p);Z!==null&&dt(z,Z.startTime-I)}}var O=!1,F=-1,X=5,U=-1;function w(){return y?!0:!(o.unstable_now()-U<X)}function G(){if(y=!1,O){var I=o.unstable_now();U=I;var Z=!0;try{t:{b=!1,C&&(C=!1,N(F),F=-1),M=!0;var Y=x;try{e:{for(A(I),v=i(m);v!==null&&!(v.expirationTime>I&&w());){var Et=v.callback;if(typeof Et=="function"){v.callback=null,x=v.priorityLevel;var L=Et(v.expirationTime<=I);if(I=o.unstable_now(),typeof L=="function"){v.callback=L,A(I),Z=!0;break e}v===i(m)&&r(m),A(I)}else r(m);v=i(m)}if(v!==null)Z=!0;else{var tt=i(p);tt!==null&&dt(z,tt.startTime-I),Z=!1}}break t}finally{v=null,x=Y,M=!1}Z=void 0}}finally{Z?lt():O=!1}}}var lt;if(typeof D=="function")lt=function(){D(G)};else if(typeof MessageChannel<"u"){var ot=new MessageChannel,vt=ot.port2;ot.port1.onmessage=G,lt=function(){vt.postMessage(null)}}else lt=function(){_(G,0)};function dt(I,Z){F=_(function(){I(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(I){I.callback=null},o.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<I?Math.floor(1e3/I):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(I){switch(x){case 1:case 2:case 3:var Z=3;break;default:Z=x}var Y=x;x=Z;try{return I()}finally{x=Y}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(I,Z){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var Y=x;x=I;try{return Z()}finally{x=Y}},o.unstable_scheduleCallback=function(I,Z,Y){var Et=o.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?Et+Y:Et):Y=Et,I){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=Y+L,I={id:g++,callback:Z,priorityLevel:I,startTime:Y,expirationTime:L,sortIndex:-1},Y>Et?(I.sortIndex=Y,t(p,I),i(m)===null&&I===i(p)&&(C?(N(F),F=-1):C=!0,dt(z,Y-Et))):(I.sortIndex=L,t(m,I),b||M||(b=!0,O||(O=!0,lt()))),I},o.unstable_shouldYield=w,o.unstable_wrapCallback=function(I){var Z=x;return function(){var Y=x;x=Z;try{return I.apply(this,arguments)}finally{x=Y}}}}(kf)),kf}var r_;function Kx(){return r_||(r_=1,Vf.exports=Zx()),Vf.exports}var Xf={exports:{}},Rn={};/**
 * @license React
...
`)+`
`+_);const D=N+y+h,A=N+_+d,z=$_(l,l.VERTEX_SHADER,D),O=$_(l,l.FRAGMENT_SHADER,A);l.attachShader(C,z),l.attachShader(C,O),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function F(G){if(o.debug.checkShaderErrors){const lt=l.getProgramInfoLog(C).trim(),ot=l.getShaderInfoLog(z).trim(),vt=l.getShaderInfoLog(O).trim();let dt=!0,I=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(dt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,C,z,O);else{const Z=e0(l,z,"vertex"),Y=e0(l,O,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
Program Info Log: `+lt+`
`+Z+`
`+Y)}else lt!==""?console.warn("THREE.WebGLProgram: Program Info Log:",lt):(ot===""||vt==="")&&(I=!1);I&&(G.diagnostics={runnable:dt,programLog:lt,vertexShader:{log:ot,prefix:y},fragmentShader:{log:vt,prefix:_}})}l.deleteShader(z),l.deleteShader(O),X=new Ac(l,C),U=Tb(l,C)}let X;this.getUniforms=function(){return X===void 0&&F(this),X};let U;this.getAttributes=function(){return U===void 0&&F(this),U};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(C,mb)),w},this.destroy=function(){r.releaseStatesOfProgram(this),l.deleteProgram(C),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=gb++,this.cacheKey=t,this.usedTimes=1,this.program=C,this.vertexShader=z,this.fragmentShader=O,this}let zb=0;class Bb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,r=t.fragmentShader,l=this._getShaderStage(i),u=this._getShaderStage(r),h=this._getShaderCacheForMaterial(t);return h.has(l)===!1&&(h.add(l),l.usedTimes++),h.has(u)===!1&&(h.add(u),u.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const r of i)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let r=i.get(t);return r===void 0&&(r=new Set,i.set(t,r)),r}_getShaderStage(t){const i=this.shaderCache;let r=i.get(t);return r===void 0&&(r=new Ib(t),i.set(t,r)),r}}class Ib{constructor(t){this.id=zb++,this.code=t,this.usedTimes=0}}function Fb(o,t,i,r,l,u,h){const d=new T0,m=new Bb,p=new Set,g=[],v=l.logarithmicDepthBuffer,x=l.vertexTextures;let M=l.precision;const b={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function C(U){return p.add(U),U===0?"uv":`uv${U}`}function y(U,w,G,lt,ot){const vt=lt.fog,dt=ot.geometry,I=U.isMeshStandardMaterial?lt.environment:null,Z=(U.isMeshStandardMaterial?i:t).get(U.envMap||I),Y=Z&&Z.mapping===Nc?Z.image.height:null,Et=b[U.type];U.precision!==null&&(M=l.getMaxPrecision(U.precision),M!==U.precision&&console.warn("THREE.WebGLProgram.getParameters:",U.precision,"not supported, using",M,"instead."));const L=dt.morphAttributes.position||dt.morphAttributes.normal||dt.morphAttributes.color,tt=L!==void 0?L.length:0;let xt=0;dt.morphAttributes.position!==void 0&&(xt=1),dt.morphAttributes.normal!==void 0&&(xt=2),dt.morphAttributes.color!==void 0&&(xt=3);let yt,Q,mt,Mt;if(Et){const Me=Ri[Et];yt=Me.vertexShader,Q=Me.fragmentShader}else yt=U.vertexShader,Q=U.fragmentShader,m.update(U),mt=m.getVertexShaderID(U),Mt=m.getFragmentShaderID(U);const Rt=o.getRenderTarget(),Ct=o.state.buffers.depth.getReversed(),oe=ot.isInstancedMesh===!0,Qt=ot.isBatchedMesh===!0,Le=!!U.map,Fe=!!U.matcap,ge=!!Z,H=!!U.aoMap,xn=!!U.lightMap,ye=!!U.bumpMap,de=!!U.normalMap,Vt=!!U.displacementMap,_e=!!U.emissiveMap,jt=!!U.metalnessMap,ae=!!U.roughnessMap,Ke=U.anisotropy>0,P=U.clearcoat>0,E=U.dispersion>0,et=U.iridescence>0,ft=U.sheen>0,pt=U.transmission>0,ct=Ke&&!!U.anisotropyMap,Pt=P&&!!U.clearcoatMap,Ut=P&&!!U.clearcoatNormalMap,Gt=P&&!!U.clearcoatRoughnessMap,kt=et&&!!U.iridescenceMap,St=et&&!!U.iridescenceThicknessMap,zt=ft&&!!U.sheenColorMap,qt=ft&&!!U.sheenRoughnessMap,Yt=!!U.specularMap,wt=!!U.specularColorMap,ie=!!U.specularIntensityMap,k=pt&&!!U.transmissionMap,Nt=pt&&!!U.thicknessMap,Tt=!!U.gradientMap,Bt=!!U.alphaMap,At=U.alphaTest>0,_t=!!U.alphaHash,Ft=!!U.extensions;let ne=Ha;U.toneMapped&&(Rt===null||Rt.isXRRenderTarget===!0)&&(ne=o.toneMapping);const De={shaderID:Et,shaderType:U.type,shaderName:U.name,vertexShader:yt,fragmentShader:Q,defines:U.defines,customVertexShaderID:mt,customFragmentShaderID:Mt,isRawShaderMaterial:U.isRawShaderMaterial===!0,glslVersion:U.glslVersion,precision:M,batching:Qt,batchingColor:Qt&&ot._colorsTexture!==null,instancing:oe,instancingColor:oe&&ot.instanceColor!==null,instancingMorph:oe&&ot.morphTexture!==null,supportsVertexTextures:x,outputColorSpace:Rt===null?o.outputColorSpace:Rt.isXRRenderTarget===!0?Rt.texture.colorSpace:Ss,alphaToCoverage:!!U.alphaToCoverage,map:Le,matcap:Fe,envMap:ge,envMapMode:ge&&Z.mapping,envMapCubeUVHeight:Y,aoMap:H,lightMap:xn,bumpMap:ye,normalMap:de,displacementMap:x&&Vt,emissiveMap:_e,normalMapObjectSpace:de&&U.normalMapType===zS,normalMapTangentSpace:de&&U.normalMapType===PS,metalnessMap:jt,roughnessMap:ae,anisotropy:Ke,anisotropyMap:ct,clearcoat:P,clearcoatMap:Pt,clearcoatNormalMap:Ut,clearcoatRoughnessMap:Gt,dispersion:E,iridescence:et,iridescenceMap:kt,iridescenceThicknessMap:St,sheen:ft,sheenColorMap:zt,sheenRoughnessMap:qt,specularMap:Yt,specularColorMap:wt,specularIntensityMap:ie,transmission:pt,transmissionMap:k,thicknessMap:Nt,gradientMap:Tt,opaque:U.transparent===!1&&U.blending===ps&&U.alphaToCoverage===!1,alphaMap:Bt,alphaTest:At,alphaHash:_t,combine:U.combine,mapUv:Le&&C(U.map.channel),aoMapUv:H&&C(U.aoMap.channel),lightMapUv:xn&&C(U.lightMap.channel),bumpMapUv:ye&&C(U.bumpMap.channel),normalMapUv:de&&C(U.normalMap.channel),displacementMapUv:Vt&&C(U.displacementMap.channel),emissiveMapUv:_e&&C(U.emissiveMap.channel),metalnessMapUv:jt&&C(U.metalnessMap.channel),roughnessMapUv:ae&&C(U.roughnessMap.channel),anisotropyMapUv:ct&&C(U.anisotropyMap.channel),clearcoatMapUv:Pt&&C(U.clearcoatMap.channel),clearcoatNormalMapUv:Ut&&C(U.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Gt&&C(U.clearcoatRoughnessMap.channel),iridescenceMapUv:kt&&C(U.iridescenceMap.channel),iridescenceThicknessMapUv:St&&C(U.iridescenceThicknessMap.channel),sheenColorMapUv:zt&&C(U.sheenColorMap.channel),sheenRoughnessMapUv:qt&&C(U.sheenRoughnessMap.channel),specularMapUv:Yt&&C(U.specularMap.channel),specularColorMapUv:wt&&C(U.specularColorMap.channel),specularIntensityMapUv:ie&&C(U.specularIntensityMap.channel),transmissionMapUv:k&&C(U.transmissionMap.channel),thicknessMapUv:Nt&&C(U.thicknessMap.channel),alphaMapUv:Bt&&C(U.alphaMap.channel),vertexTangents:!!dt.attributes.tangent&&(de||Ke),vertexColors:U.vertexColors,vertexAlphas:U.vertexColors===!0&&!!dt.attributes.color&&dt.attributes.color.itemSize===4,pointsUvs:ot.isPoints===!0&&!!dt.attributes.uv&&(Le||Bt),fog:!!vt,useFog:U.fog===!0,fogExp2:!!vt&&vt.isFogExp2,flatShading:U.flatShading===!0&&U.wireframe===!1,sizeAttenuation:U.sizeAttenuation===!0,logarithmicDepthBuffer:v,reverseDepthBuffer:Ct,skinning:ot.isSkinnedMesh===!0,morphTargets:dt.morphAttributes.position!==void 0,morphNormals:dt.morphAttributes.normal!==void 0,morphColors:dt.morphAttributes.color!==void 0,morphTargetsCount:tt,morphTextureStride:xt,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:h.numPlanes,numClipIntersection:h.numIntersection,dithering:U.dithering,shadowMapEnabled:o.shadowMap.enabled&&G.length>0,shadowMapType:o.shadowMap.type,toneMapping:ne,decodeVideoTexture:Le&&U.map.isVideoTexture===!0&&Te.getTransfer(U.map.colorSpace)===Ie,decodeVideoTextureEmissive:_e&&U.emissiveMap.isVideoTexture===!0&&Te.getTransfer(U.emissiveMap.colorSpace)===Ie,premultipliedAlpha:U.premultipliedAlpha,doubleSided:U.side===ta,flipSided:U.side===Gn,useDepthPacking:U.depthPacking>=0,depthPacking:U.depthPacking||0,index0AttributeName:U.index0AttributeName,extensionClipCullDistance:Ft&&U.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ft&&U.extensions.multiDraw===!0||Qt)&&r.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:U.customProgramCacheKey()};return De.vertexUv1s=p.has(1),De.vertexUv2s=p.has(2),De.vertexUv3s=p.has(3),p.clear(),De}function _(U){const w=[];if(U.shaderID?w.push(U.shaderID):(w.push(U.customVertexShaderID),w.push(U.customFragmentShaderID)),U.defines!==void 0)for(const G in U.defines)w.push(G),w.push(U.defines[G]);return U.isRawShaderMaterial===!1&&(N(w,U),D(w,U),w.push(o.outputColorSpace)),w.push(U.customProgramCacheKey),w.join()}function N(U,w){U.push(w.precision),U.push(w.outputColorSpace),U.push(w.envMapMode),U.push(w.envMapCubeUVHeight),U.push(w.mapUv),U.push(w.alphaMapUv),U.push(w.lightMapUv),U.push(w.aoMapUv),U.push(w.bumpMapUv),U.push(w.normalMapUv),U.push(w.displacementMapUv),U.push(w.emissiveMapUv),U.push(w.metalnessMapUv),U.push(w.roughnessMapUv),U.push(w.anisotropyMapUv),U.push(w.clearcoatMapUv),U.push(w.clearcoatNormalMapUv),U.push(w.clearcoatRoughnessMapUv),U.push(w.iridescenceMapUv),U.push(w.iridescenceThicknessMapUv),U.push(w.sheenColorMapUv),U.push(w.sheenRoughnessMapUv),U.push(w.specularMapUv),U.push(w.specularColorMapUv),U.push(w.specularIntensityMapUv),U.push(w.transmissionMapUv),U.push(w.thicknessMapUv),U.push(w.combine),U.push(w.fogExp2),U.push(w.sizeAttenuation),U.push(w.morphTargetsCount),U.push(w.morphAttributeCount),U.push(w.numDirLights),U.push(w.numPointLights),U.push(w.numSpotLights),U.push(w.numSpotLightMaps),U.push(w.numHemiLights),U.push(w.numRectAreaLights),U.push(w.numDirLightShadows),U.push(w.numPointLightShadows),U.push(w.numSpotLightShadows),U.push(w.numSpotLightShadowsWithMaps),U.push(w.numLightProbes),U.push(w.shadowMapType),U.push(w.toneMapping),U.push(w.numClippingPlanes),U.push(w.numClipIntersection),U.push(w.depthPacking)}function D(U,w){d.disableAll(),w.supportsVertexTextures&&d.enable(0),w.instancing&&d.enable(1),w.instancingColor&&d.enable(2),w.instancingMorph&&d.enable(3),w.matcap&&d.enable(4),w.envMap&&d.enable(5),w.normalMapObjectSpace&&d.enable(6),w.normalMapTangentSpace&&d.enable(7),w.clearcoat&&d.enable(8),w.iridescence&&d.enable(9),w.alphaTest&&d.enable(10),w.vertexColors&&d.enable(11),w.vertexAlphas&&d.enable(12),w.vertexUv1s&&d.enable(13),w.vertexUv2s&&d.enable(14),w.vertexUv3s&&d.enable(15),w.vertexTangents&&d.enable(16),w.anisotropy&&d.enable(17),w.alphaHash&&d.enable(18),w.batching&&d.enable(19),w.dispersion&&d.enable(20),w.batchingColor&&d.enable(21),w.gradientMap&&d.enable(22),U.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reverseDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),U.push(d.mask)}function A(U){const w=b[U.type];let G;if(w){const lt=Ri[w];G=dy.clone(lt.uniforms)}else G=U.uniforms;return G}function z(U,w){let G;for(let lt=0,ot=g.length;lt<ot;lt++){const vt=g[lt];if(vt.cacheKey===w){G=vt,++G.usedTimes;break}}return G===void 0&&(G=new Pb(o,w,U,u),g.push(G)),G}function O(U){if(--U.usedTimes===0){const w=g.indexOf(U);g[w]=g[g.length-1],g.pop(),U.destroy()}}function F(U){m.remove(U)}function X(){m.dispose()}return{getParameters:y,getProgramCacheKey:_,getUniforms:A,acquireProgram:z,releaseProgram:O,releaseShaderCache:F,programs:g,dispose:X}}function Hb(){let o=new WeakMap;function t(h){return o.has(h)}function i(h){let d=o.get(h);return d===void 0&&(d={},o.set(h,d)),d}function r(h){o.delete(h)}function l(h,d,m){o.get(h)[d]=m}function u(){o=new WeakMap}return{has:t,get:i,remove:r,update:l,dispose:u}}function Gb(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.material.id!==t.material.id?o.material.id-t.material.id:o.z!==t.z?o.z-t.z:o.id-t.id}function s0(o,t){return o.groupOrder!==t.groupOrder?o.groupOrder-t.groupOrder:o.renderOrder!==t.renderOrder?o.renderOrder-t.renderOrder:o.z!==t.z?t.z-o.z:o.id-t.id}function o0(){const o=[];let t=0;const i=[],r=[],l=[];function u(){t=0,i.length=0,r.length=0,l.length=0}function h(v,x,M,b,C,y){let _=o[t];return _===void 0?(_={id:v.id,object:v,geometry:x,material:M,groupOrder:b,renderOrder:v.renderOrder,z:C,group:y},o[t]=_):(_.id=v.id,_.object=v,_.geometry=x,_.material=M,_.groupOrder=b,_.renderOrder=v.renderOrder,_.z=C,_.group=y),t++,_}function d(v,x,M,b,C,y){const _=h(v,x,M,b,C,y);M.transmission>0?r.push(_):M.transparent===!0?l.push(_):i.push(_)}function m(v,x,M,b,C,y){const _=h(v,x,M,b,C,y);M.transmission>0?r.unshift(_):M.transparent===!0?l.unshift(_):i.unshift(_)}function p(v,x){i.length>1&&i.sort(v||Gb),r.length>1&&r.sort(x||s0),l.length>1&&l.sort(x||s0)}function g(){for(let v=t,x=o.length;v<x;v++){const M=o[v];if(M.id===null)break;M.id=null,M.object=null,M.geometry=null,M.material=null,M.group=null}}return{opaque:i,transmissive:r,transparent:l,init:u,push:d,unshift:m,finish:g,sort:p}}function Vb(){let o=new WeakMap;function t(r,l){const u=o.get(r);let h;return u===void 0?(h=new o0,o.set(r,[h])):l>=u.length?(h=new o0,u.push(h)):h=u[l],h}function i(){o=new WeakMap}return{get:t,dispose:i}}function kb(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new $,color:new Ce};break;case"SpotLight":i={position:new $,direction:new $,color:new Ce,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new $,color:new Ce,distance:0,decay:0};break;case"HemisphereLight":i={direction:new $,skyColor:new Ce,groundColor:new Ce};break;case"RectAreaLight":i={color:new Ce,position:new $,halfWidth:new $,halfHeight:new $};break}return o[t.id]=i,i}}}function Xb(){const o={};return{get:function(t){if(o[t.id]!==void 0)return o[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be,shadowCameraNear:1,shadowCameraFar:1e3};break}return o[t.id]=i,i}}}let Wb=0;function qb(o,t){return(t.castShadow?2:0)-(o.castShadow?2:0)+(t.map?1:0)-(o.map?1:0)}function Yb(o){const t=new kb,i=Xb(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)r.probe.push(new $);const l=new $,u=new Ze,h=new Ze;function d(p){let g=0,v=0,x=0;for(let U=0;U<9;U++)r.probe[U].set(0,0,0);let M=0,b=0,C=0,y=0,_=0,N=0,D=0,A=0,z=0,O=0,F=0;p.sort(qb);for(let U=0,w=p.length;U<w;U++){const G=p[U],lt=G.color,ot=G.intensity,vt=G.distance,dt=G.shadow&&G.shadow.map?G.shadow.map.texture:null;if(G.isAmbientLight)g+=lt.r*ot,v+=lt.g*ot,x+=lt.b*ot;else if(G.isLightProbe){for(let I=0;I<9;I++)r.probe[I].addScaledVector(G.sh.coefficients[I],ot);F++}else if(G.isDirectionalLight){const I=t.get(G);if(I.color.copy(G.color).multiplyScalar(G.intensity),G.castShadow){const Z=G.shadow,Y=i.get(G);Y.shadowIntensity=Z.intensity,Y.shadowBias=Z.bias,Y.shadowNormalBias=Z.normalBias,Y.shadowRadius=Z.radius,Y.shadowMapSize=Z.mapSize,r.directionalShadow[M]=Y,r.directionalShadowMap[M]=dt,r.directionalShadowMatrix[M]=G.shadow.matrix,N++}r.directional[M]=I,M++}else if(G.isSpotLight){const I=t.get(G);I.position.setFromMatrixPosition(G.matrixWorld),I.color.copy(lt).multiplyScalar(ot),I.distance=vt,I.coneCos=Math.cos(G.angle),I.penumbraCos=Math.cos(G.angle*(1-G.penumbra)),I.decay=G.decay,r.spot[C]=I;const Z=G.shadow;if(G.map&&(r.spotLightMap[z]=G.map,z++,Z.updateMatrices(G),G.castShadow&&O++),r.spotLightMatrix[C]=Z.matrix,G.castShadow){const Y=i.get(G);Y.shadowIntensity=Z.intensity,Y.shadowBias=Z.bias,Y.shadowNormalBias=Z.normalBias,Y.shadowRadius=Z.radius,Y.shadowMapSize=Z.mapSize,r.spotShadow[C]=Y,r.spotShadowMap[C]=dt,A++}C++}else if(G.isRectAreaLight){const I=t.get(G);I.color.copy(lt).multiplyScalar(ot),I.halfWidth.set(G.width*.5,0,0),I.halfHeight.set(0,G.height*.5,0),r.rectArea[y]=I,y++}else if(G.isPointLight){const I=t.get(G);if(I.color.copy(G.color).multiplyScalar(G.intensity),I.distance=G.distance,I.decay=G.decay,G.castShadow){const Z=G.shadow,Y=i.get(G);Y.shadowIntensity=Z.intensity,Y.shadowBias=Z.bias,Y.shadowNormalBias=Z.normalBias,Y.shadowRadius=Z.radius,Y.shadowMapSize=Z.mapSize,Y.shadowCameraNear=Z.camera.near,Y.shadowCameraFar=Z.camera.far,r.pointShadow[b]=Y,r.pointShadowMap[b]=dt,r.pointShadowMatrix[b]=G.shadow.matrix,D++}r.point[b]=I,b++}else if(G.isHemisphereLight){const I=t.get(G);I.skyColor.copy(G.color).multiplyScalar(ot),I.groundColor.copy(G.groundColor).multiplyScalar(ot),r.hemi[_]=I,_++}}y>0&&(o.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=Lt.LTC_FLOAT_1,r.rectAreaLTC2=Lt.LTC_FLOAT_2):(r.rectAreaLTC1=Lt.LTC_HALF_1,r.rectAreaLTC2=Lt.LTC_HALF_2)),r.ambient[0]=g,r.ambient[1]=v,r.ambient[2]=x;const X=r.hash;(X.directionalLength!==M||X.pointLength!==b||X.spotLength!==C||X.rectAreaLength!==y||X.hemiLength!==_||X.numDirectionalShadows!==N||X.numPointShadows!==D||X.numSpotShadows!==A||X.numSpotMaps!==z||X.numLightProbes!==F)&&(r.directional.length=M,r.spot.length=C,r.rectArea.length=y,r.point.length=b,r.hemi.length=_,r.directionalShadow.length=N,r.directionalShadowMap.length=N,r.pointShadow.length=D,r.pointShadowMap.length=D,r.spotShadow.length=A,r.spotShadowMap.length=A,r.directionalShadowMatrix.length=N,r.pointShadowMatrix.length=D,r.spotLightMatrix.length=A+z-O,r.spotLightMap.length=z,r.numSpotLightShadowsWithMaps=O,r.numLightProbes=F,X.directionalLength=M,X.pointLength=b,X.spotLength=C,X.rectAreaLength=y,X.hemiLength=_,X.numDirectionalShadows=N,X.numPointShadows=D,X.numSpotShadows=A,X.numSpotMaps=z,X.numLightProbes=F,r.version=Wb++)}function m(p,g){let v=0,x=0,M=0,b=0,C=0;const y=g.matrixWorldInverse;for(let _=0,N=p.length;_<N;_++){const D=p[_];if(D.isDirectionalLight){const A=r.directional[v];A.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),A.direction.sub(l),A.direction.transformDirection(y),v++}else if(D.isSpotLight){const A=r.spot[M];A.position.setFromMatrixPosition(D.matrixWorld),A.position.applyMatrix4(y),A.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),A.direction.sub(l),A.direction.transformDirection(y),M++}else if(D.isRectAreaLight){const A=r.rectArea[b];A.position.setFromMatrixPosition(D.matrixWorld),A.position.applyMatrix4(y),h.identity(),u.copy(D.matrixWorld),u.premultiply(y),h.extractRotation(u),A.halfWidth.set(D.width*.5,0,0),A.halfHeight.set(0,D.height*.5,0),A.halfWidth.applyMatrix4(h),A.halfHeight.applyMatrix4(h),b++}else if(D.isPointLight){const A=r.point[x];A.position.setFromMatrixPosition(D.matrixWorld),A.position.applyMatrix4(y),x++}else if(D.isHemisphereLight){const A=r.hemi[C];A.direction.setFromMatrixPosition(D.matrixWorld),A.direction.transformDirection(y),C++}}}return{setup:d,setupView:m,state:r}}function l0(o){const t=new Yb(o),i=[],r=[];function l(g){p.camera=g,i.length=0,r.length=0}function u(g){i.push(g)}function h(g){r.push(g)}function d(){t.setup(i)}function m(g){t.setupView(i,g)}const p={lightsArray:i,shadowsArray:r,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:u,pushShadow:h}}function jb(o){let t=new WeakMap;function i(l,u=0){const h=t.get(l);let d;return h===void 0?(d=new l0(o),t.set(l,[d])):u>=h.length?(d=new l0(o),h.push(d)):d=h[u],d}function r(){t=new WeakMap}return{get:i,dispose:r}}const Zb=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Qb(o,t,i){let r=new N0;const l=new be,u=new be,h=new $e,d=new Ey({depthPacking:OS}),m=new Ty,p={},g=i.maxTextureSize,v={[Ga]:Gn,[Gn]:Ga,[ta]:ta},x=new Va({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new be},radius:{value:4}},vertexShader:Zb,fragmentShader:Kb}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const b=new Ln;b.setAttribute("position",new Si(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new vi(b,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=u0;let _=this.type;this.render=function(O,F,X){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||O.length===0)return;const U=o.getRenderTarget(),w=o.getActiveCubeFace(),G=o.getActiveMipmapLevel(),lt=o.state;lt.setBlending(Fa),lt.buffers.color.setClear(1,1,1,1),lt.buffers.depth.setTest(!0),lt.setScissorTest(!1);const ot=_!==$i&&this.type===$i,vt=_===$i&&this.type!==$i;for(let dt=0,I=O.length;dt<I;dt++){const Z=O[dt],Y=Z.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;l.copy(Y.mapSize);const Et=Y.getFrameExtents();if(l.multiply(Et),u.copy(Y.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(u.x=Math.floor(g/Et.x),l.x=u.x*Et.x,Y.mapSize.x=u.x),l.y>g&&(u.y=Math.floor(g/Et.y),l.y=u.y*Et.y,Y.mapSize.y=u.y)),Y.map===null||ot===!0||vt===!0){const tt=this.type!==$i?{minFilter:xi,magFilter:xi}:{};Y.map!==null&&Y.map.dispose(),Y.map=new yr(l.x,l.y,tt),Y.map.texture.name=Z.name+".shadowMap",Y.camera.updateProjectionMatrix()}o.setRenderTarget(Y.map),o.clear();const L=Y.getViewportCount();for(let tt=0;tt<L;tt++){const xt=Y.getViewport(tt);h.set(u.x*xt.x,u.y*xt.y,u.x*xt.z,u.y*xt.w),lt.viewport(h),Y.updateMatrices(Z,tt),r=Y.getFrustum(),A(F,X,Y.camera,Z,this.type)}Y.isPointLightShadow!==!0&&this.type===$i&&N(Y,X),Y.needsUpdate=!1}_=this.type,y.needsUpdate=!1,o.setRenderTarget(U,w,G)};function N(O,F){const X=t.update(C);x.defines.VSM_SAMPLES!==O.blurSamples&&(x.defines.VSM_SAMPLES=O.blurSamples,M.defines.VSM_SAMPLES=O.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),O.mapPass===null&&(O.mapPass=new yr(l.x,l.y)),x.uniforms.shadow_pass.value=O.map.texture,x.uniforms.resolution.value=O.mapSize,x.uniforms.radius.value=O.radius,o.setRenderTarget(O.mapPass),o.clear(),o.renderBufferDirect(F,null,X,x,C,null),M.uniforms.shadow_pass.value=O.mapPass.texture,M.uniforms.resolution.value=O.mapSize,M.uniforms.radius.value=O.radius,o.setRenderTarget(O.map),o.clear(),o.renderBufferDirect(F,null,X,M,C,null)}function D(O,F,X,U){let w=null;const G=X.isPointLight===!0?O.customDistanceMaterial:O.customDepthMaterial;if(G!==void 0)w=G;else if(w=X.isPointLight===!0?m:d,o.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0||F.alphaToCoverage===!0){const lt=w.uuid,ot=F.uuid;let vt=p[lt];vt===void 0&&(vt={},p[lt]=vt);let dt=vt[ot];dt===void 0&&(dt=w.clone(),vt[ot]=dt,F.addEventListener("dispose",z)),w=dt}if(w.visible=F.visible,w.wireframe=F.wireframe,U===$i?w.side=F.shadowSide!==null?F.shadowSide:F.side:w.side=F.shadowSide!==null?F.shadowSide:v[F.side],w.alphaMap=F.alphaMap,w.alphaTest=F.alphaToCoverage===!0?.5:F.alphaTest,w.map=F.map,w.clipShadows=F.clipShadows,w.clippingPlanes=F.clippingPlanes,w.clipIntersection=F.clipIntersection,w.displacementMap=F.displacementMap,w.displacementScale=F.displacementScale,w.displacementBias=F.displacementBias,w.wireframeLinewidth=F.wireframeLinewidth,w.linewidth=F.linewidth,X.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const lt=o.properties.get(w);lt.light=X}return w}function A(O,F,X,U,w){if(O.visible===!1)return;if(O.layers.test(F.layers)&&(O.isMesh||O.isLine||O.isPoints)&&(O.castShadow||O.receiveShadow&&w===$i)&&(!O.frustumCulled||r.intersectsObject(O))){O.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,O.matrixWorld);const ot=t.update(O),vt=O.material;if(Array.isArray(vt)){const dt=ot.groups;for(let I=0,Z=dt.length;I<Z;I++){const Y=dt[I],Et=vt[Y.materialIndex];if(Et&&Et.visible){const L=D(O,Et,U,w);O.onBeforeShadow(o,O,F,X,ot,L,Y),o.renderBufferDirect(X,null,ot,L,O,Y),O.onAfterShadow(o,O,F,X,ot,L,Y)}}}else if(vt.visible){const dt=D(O,vt,U,w);O.onBeforeShadow(o,O,F,X,ot,dt,null),o.renderBufferDirect(X,null,ot,dt,O,null),O.onAfterShadow(o,O,F,X,ot,dt,null)}}const lt=O.children;for(let ot=0,vt=lt.length;ot<vt;ot++)A(lt[ot],F,X,U,w)}function z(O){O.target.removeEventListener("dispose",z);for(const X in p){const U=p[X],w=O.target.uuid;w in U&&(U[w].dispose(),delete U[w])}}}const Jb={[bh]:Ah,[Rh]:Dh,[wh]:Uh,[_s]:Ch,[Ah]:bh,[Dh]:Rh,[Uh]:wh,[Ch]:_s};function $b(o,t){function i(){let k=!1;const Nt=new $e;let Tt=null;const Bt=new $e(0,0,0,0);return{setMask:function(At){Tt!==At&&!k&&(o.colorMask(At,At,At,At),Tt=At)},setLocked:function(At){k=At},setClear:function(At,_t,Ft,ne,De){De===!0&&(At*=ne,_t*=ne,Ft*=ne),Nt.set(At,_t,Ft,ne),Bt.equals(Nt)===!1&&(o.clearColor(At,_t,Ft,ne),Bt.copy(Nt))},reset:function(){k=!1,Tt=null,Bt.set(-1,0,0,0)}}}function r(){let k=!1,Nt=!1,Tt=null,Bt=null,At=null;return{setReversed:function(_t){if(Nt!==_t){const Ft=t.get("EXT_clip_control");_t?Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.ZERO_TO_ONE_EXT):Ft.clipControlEXT(Ft.LOWER_LEFT_EXT,Ft.NEGATIVE_ONE_TO_ONE_EXT),Nt=_t;const ne=At;At=null,this.setClear(ne)}},getReversed:function(){return Nt},setTest:function(_t){_t?Rt(o.DEPTH_TEST):Ct(o.DEPTH_TEST)},setMask:function(_t){Tt!==_t&&!k&&(o.depthMask(_t),Tt=_t)},setFunc:function(_t){if(Nt&&(_t=Jb[_t]),Bt!==_t){switch(_t){case bh:o.depthFunc(o.NEVER);break;case Ah:o.depthFunc(o.ALWAYS);break;case Rh:o.depthFunc(o.LESS);break;case _s:o.depthFunc(o.LEQUAL);break;case wh:o.depthFunc(o.EQUAL);break;case Ch:o.depthFunc(o.GEQUAL);break;case Dh:o.depthFunc(o.GREATER);break;case Uh:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Bt=_t}},setLocked:function(_t){k=_t},setClear:function(_t){At!==_t&&(Nt&&(_t=1-_t),o.clearDepth(_t),At=_t)},reset:function(){k=!1,Tt=null,Bt=null,At=null,Nt=!1}}}function l(){let k=!1,Nt=null,Tt=null,Bt=null,At=null,_t=null,Ft=null,ne=null,De=null;return{setTest:function(Me){k||(Me?Rt(o.STENCIL_TEST):Ct(o.STENCIL_TEST))},setMask:function(Me){Nt!==Me&&!k&&(o.stencilMask(Me),Nt=Me)},setFunc:function(Me,Xn,fn){(Tt!==Me||Bt!==Xn||At!==fn)&&(o.stencilFunc(Me,Xn,fn),Tt=Me,Bt=Xn,At=fn)},setOp:function(Me,Xn,fn){(_t!==Me||Ft!==Xn||ne!==fn)&&(o.stencilOp(Me,Xn,fn),_t=Me,Ft=Xn,ne=fn)},setLocked:function(Me){k=Me},setClear:function(Me){De!==Me&&(o.clearStencil(Me),De=Me)},reset:function(){k=!1,Nt=null,Tt=null,Bt=null,At=null,_t=null,Ft=null,ne=null,De=null}}}const u=new i,h=new r,d=new l,m=new WeakMap,p=new WeakMap;let g={},v={},x=new WeakMap,M=[],b=null,C=!1,y=null,_=null,N=null,D=null,A=null,z=null,O=null,F=new Ce(0,0,0),X=0,U=!1,w=null,G=null,lt=null,ot=null,vt=null;const dt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,Z=0;const Y=o.getParameter(o.VERSION);Y.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(Y)[1]),I=Z>=1):Y.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),I=Z>=2);let Et=null,L={};const tt=o.getParameter(o.SCISSOR_BOX),xt=o.getParameter(o.VIEWPORT),yt=new $e().fromArray(tt),Q=new $e().fromArray(xt);function mt(k,Nt,Tt,Bt){const At=new Uint8Array(4),_t=o.createTexture();o.bindTexture(k,_t),o.texParameteri(k,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(k,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Ft=0;Ft<Tt;Ft++)k===o.TEXTURE_3D||k===o.TEXTURE_2D_ARRAY?o.texImage3D(Nt,0,o.RGBA,1,1,Bt,0,o.RGBA,o.UNSIGNED_BYTE,At):o.texImage2D(Nt+Ft,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,At);return _t}const Mt={};Mt[o.TEXTURE_2D]=mt(o.TEXTURE_2D,o.TEXTURE_2D,1),Mt[o.TEXTURE_CUBE_MAP]=mt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),Mt[o.TEXTURE_2D_ARRAY]=mt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),Mt[o.TEXTURE_3D]=mt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),h.setClear(1),d.setClear(0),Rt(o.DEPTH_TEST),h.setFunc(_s),ye(!1),de(u_),Rt(o.CULL_FACE),H(Fa);function Rt(k){g[k]!==!0&&(o.enable(k),g[k]=!0)}function Ct(k){g[k]!==!1&&(o.disable(k),g[k]=!1)}function oe(k,Nt){return v[k]!==Nt?(o.bindFramebuffer(k,Nt),v[k]=Nt,k===o.DRAW_FRAMEBUFFER&&(v[o.FRAMEBUFFER]=Nt),k===o.FRAMEBUFFER&&(v[o.DRAW_FRAMEBUFFER]=Nt),!0):!1}function Qt(k,Nt){let Tt=M,Bt=!1;if(k){Tt=x.get(Nt),Tt===void 0&&(Tt=[],x.set(Nt,Tt));const At=k.textures;if(Tt.length!==At.length||Tt[0]!==o.COLOR_ATTACHMENT0){for(let _t=0,Ft=At.length;_t<Ft;_t++)Tt[_t]=o.COLOR_ATTACHMENT0+_t;Tt.length=At.length,Bt=!0}}else Tt[0]!==o.BACK&&(Tt[0]=o.BACK,Bt=!0);Bt&&o.drawBuffers(Tt)}function Le(k){return b!==k?(o.useProgram(k),b=k,!0):!1}const Fe={[gr]:o.FUNC_ADD,[sS]:o.FUNC_SUBTRACT,[oS]:o.FUNC_REVERSE_SUBTRACT};Fe[lS]=o.MIN,Fe[cS]=o.MAX;const ge={[uS]:o.ZERO,[fS]:o.ONE,[hS]:o.SRC_COLOR,[Eh]:o.SRC_ALPHA,[vS]:o.SRC_ALPHA_SATURATE,[gS]:o.DST_COLOR,[pS]:o.DST_ALPHA,[dS]:o.ONE_MINUS_SRC_COLOR,[Th]:o.ONE_MINUS_SRC_ALPHA,[_S]:o.ONE_MINUS_DST_COLOR,[mS]:o.ONE_MINUS_DST_ALPHA,[xS]:o.CONSTANT_COLOR,[SS]:o.ONE_MINUS_CONSTANT_COLOR,[yS]:o.CONSTANT_ALPHA,[MS]:o.ONE_MINUS_CONSTANT_ALPHA};function H(k,Nt,Tt,Bt,At,_t,Ft,ne,De,Me){if(k===Fa){C===!0&&(Ct(o.BLEND),C=!1);return}if(C===!1&&(Rt(o.BLEND),C=!0),k!==rS){if(k!==y||Me!==U){if((_!==gr||A!==gr)&&(o.blendEquation(o.FUNC_ADD),_=gr,A=gr),Me)switch(k){case ps:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case f_:o.blendFunc(o.ONE,o.ONE);break;case h_:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case d_:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}else switch(k){case ps:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case f_:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case h_:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case d_:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}N=null,D=null,z=null,O=null,F.set(0,0,0),X=0,y=k,U=Me}return}At=At||Nt,_t=_t||Tt,Ft=Ft||Bt,(Nt!==_||At!==A)&&(o.blendEquationSeparate(Fe[Nt],Fe[At]),_=Nt,A=At),(Tt!==N||Bt!==D||_t!==z||Ft!==O)&&(o.blendFuncSeparate(ge[Tt],ge[Bt],ge[_t],ge[Ft]),N=Tt,D=Bt,z=_t,O=Ft),(ne.equals(F)===!1||De!==X)&&(o.blendColor(ne.r,ne.g,ne.b,De),F.copy(ne),X=De),y=k,U=!1}function xn(k,Nt){k.side===ta?Ct(o.CULL_FACE):Rt(o.CULL_FACE);let Tt=k.side===Gn;Nt&&(Tt=!Tt),ye(Tt),k.blending===ps&&k.transparent===!1?H(Fa):H(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),h.setFunc(k.depthFunc),h.setTest(k.depthTest),h.setMask(k.depthWrite),u.setMask(k.colorWrite);const Bt=k.stencilWrite;d.setTest(Bt),Bt&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),_e(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?Rt(o.SAMPLE_ALPHA_TO_COVERAGE):Ct(o.SAMPLE_ALPHA_TO_COVERAGE)}function ye(k){w!==k&&(k?o.frontFace(o.CW):o.frontFace(o.CCW),w=k)}function de(k){k!==nS?(Rt(o.CULL_FACE),k!==G&&(k===u_?o.cullFace(o.BACK):k===iS?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Ct(o.CULL_FACE),G=k}function Vt(k){k!==lt&&(I&&o.lineWidth(k),lt=k)}function _e(k,Nt,Tt){k?(Rt(o.POLYGON_OFFSET_FILL),(ot!==Nt||vt!==Tt)&&(o.polygonOffset(Nt,Tt),ot=Nt,vt=Tt)):Ct(o.POLYGON_OFFSET_FILL)}function jt(k){k?Rt(o.SCISSOR_TEST):Ct(o.SCISSOR_TEST)}function ae(k){k===void 0&&(k=o.TEXTURE0+dt-1),Et!==k&&(o.activeTexture(k),Et=k)}function Ke(k,Nt,Tt){Tt===void 0&&(Et===null?Tt=o.TEXTURE0+dt-1:Tt=Et);let Bt=L[Tt];Bt===void 0&&(Bt={type:void 0,texture:void 0},L[Tt]=Bt),(Bt.type!==k||Bt.texture!==Nt)&&(Et!==Tt&&(o.activeTexture(Tt),Et=Tt),o.bindTexture(k,Nt||Mt[k]),Bt.type=k,Bt.texture=Nt)}function P(){const k=L[Et];k!==void 0&&k.type!==void 0&&(o.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function E(){try{o.compressedTexImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function et(){try{o.compressedTexImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ft(){try{o.texSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function pt(){try{o.texSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function ct(){try{o.compressedTexSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Pt(){try{o.compressedTexSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Ut(){try{o.texStorage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Gt(){try{o.texStorage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function kt(){try{o.texImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function St(){try{o.texImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function zt(k){yt.equals(k)===!1&&(o.scissor(k.x,k.y,k.z,k.w),yt.copy(k))}function qt(k){Q.equals(k)===!1&&(o.viewport(k.x,k.y,k.z,k.w),Q.copy(k))}function Yt(k,Nt){let Tt=p.get(Nt);Tt===void 0&&(Tt=new WeakMap,p.set(Nt,Tt));let Bt=Tt.get(k);Bt===void 0&&(Bt=o.getUniformBlockIndex(Nt,k.name),Tt.set(k,Bt))}function wt(k,Nt){const Bt=p.get(Nt).get(k);m.get(Nt)!==Bt&&(o.uniformBlockBinding(Nt,Bt,k.__bindingPointIndex),m.set(Nt,Bt))}function ie(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),h.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),g={},Et=null,L={},v={},x=new WeakMap,M=[],b=null,C=!1,y=null,_=null,N=null,D=null,A=null,z=null,O=null,F=new Ce(0,0,0),X=0,U=!1,w=null,G=null,lt=null,ot=null,vt=null,yt.set(0,0,o.canvas.width,o.canvas.height),Q.set(0,0,o.canvas.width,o.canvas.height),u.reset(),h.reset(),d.reset()}return{buffers:{color:u,depth:h,stencil:d},enable:Rt,disable:Ct,bindFramebuffer:oe,drawBuffers:Qt,useProgram:Le,setBlending:H,setMaterial:xn,setFlipSided:ye,setCullFace:de,setLineWidth:Vt,setPolygonOffset:_e,setScissorTest:jt,activeTexture:ae,bindTexture:Ke,unbindTexture:P,compressedTexImage2D:E,compressedTexImage3D:et,texImage2D:kt,texImage3D:St,updateUBOMapping:Yt,uniformBlockBinding:wt,texStorage2D:Ut,texStorage3D:Gt,texSubImage2D:ft,texSubImage3D:pt,compressedTexSubImage2D:ct,compressedTexSubImage3D:Pt,scissor:zt,viewport:qt,reset:ie}}function t1(o,t,i,r,l,u,h){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new be,g=new WeakMap;let v;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(P,E){return M?new OffscreenCanvas(P,E):Cc("canvas")}function C(P,E,et){let ft=1;const pt=Ke(P);if((pt.width>et||pt.height>et)&&(ft=et/Math.max(pt.width,pt.height)),ft<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const ct=Math.floor(ft*pt.width),Pt=Math.floor(ft*pt.height);v===void 0&&(v=b(ct,Pt));const Ut=E?b(ct,Pt):v;return Ut.width=ct,Ut.height=Pt,Ut.getContext("2d").drawImage(P,0,0,ct,Pt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pt.width+"x"+pt.height+") to ("+ct+"x"+Pt+")."),Ut}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pt.width+"x"+pt.height+")."),P;return P}function y(P){return P.generateMipmaps}function _(P){o.generateMipmap(P)}function N(P){return P.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?o.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function D(P,E,et,ft,pt=!1){if(P!==null){if(o[P]!==void 0)return o[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let ct=E;if(E===o.RED&&(et===o.FLOAT&&(ct=o.R32F),et===o.HALF_FLOAT&&(ct=o.R16F),et===o.UNSIGNED_BYTE&&(ct=o.R8)),E===o.RED_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.R8UI),et===o.UNSIGNED_SHORT&&(ct=o.R16UI),et===o.UNSIGNED_INT&&(ct=o.R32UI),et===o.BYTE&&(ct=o.R8I),et===o.SHORT&&(ct=o.R16I),et===o.INT&&(ct=o.R32I)),E===o.RG&&(et===o.FLOAT&&(ct=o.RG32F),et===o.HALF_FLOAT&&(ct=o.RG16F),et===o.UNSIGNED_BYTE&&(ct=o.RG8)),E===o.RG_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RG8UI),et===o.UNSIGNED_SHORT&&(ct=o.RG16UI),et===o.UNSIGNED_INT&&(ct=o.RG32UI),et===o.BYTE&&(ct=o.RG8I),et===o.SHORT&&(ct=o.RG16I),et===o.INT&&(ct=o.RG32I)),E===o.RGB_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RGB8UI),et===o.UNSIGNED_SHORT&&(ct=o.RGB16UI),et===o.UNSIGNED_INT&&(ct=o.RGB32UI),et===o.BYTE&&(ct=o.RGB8I),et===o.SHORT&&(ct=o.RGB16I),et===o.INT&&(ct=o.RGB32I)),E===o.RGBA_INTEGER&&(et===o.UNSIGNED_BYTE&&(ct=o.RGBA8UI),et===o.UNSIGNED_SHORT&&(ct=o.RGBA16UI),et===o.UNSIGNED_INT&&(ct=o.RGBA32UI),et===o.BYTE&&(ct=o.RGBA8I),et===o.SHORT&&(ct=o.RGBA16I),et===o.INT&&(ct=o.RGBA32I)),E===o.RGB&&et===o.UNSIGNED_INT_5_9_9_9_REV&&(ct=o.RGB9_E5),E===o.RGBA){const Pt=pt?Rc:Te.getTransfer(ft);et===o.FLOAT&&(ct=o.RGBA32F),et===o.HALF_FLOAT&&(ct=o.RGBA16F),et===o.UNSIGNED_BYTE&&(ct=Pt===Ie?o.SRGB8_ALPHA8:o.RGBA8),et===o.UNSIGNED_SHORT_4_4_4_4&&(ct=o.RGBA4),et===o.UNSIGNED_SHORT_5_5_5_1&&(ct=o.RGB5_A1)}return(ct===o.R16F||ct===o.R32F||ct===o.RG16F||ct===o.RG32F||ct===o.RGBA16F||ct===o.RGBA32F)&&t.get("EXT_color_buffer_float"),ct}function A(P,E){let et;return P?E===null||E===Sr||E===Do?et=o.DEPTH24_STENCIL8:E===ea?et=o.DEPTH32F_STENCIL8:E===Co&&(et=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Sr||E===Do?et=o.DEPTH_COMPONENT24:E===ea?et=o.DEPTH_COMPONENT32F:E===Co&&(et=o.DEPTH_COMPONENT16),et}function z(P,E){return y(P)===!0||P.isFramebufferTexture&&P.minFilter!==xi&&P.minFilter!==wi?Math.log2(Math.max(E.width,E.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?E.mipmaps.length:1}function O(P){const E=P.target;E.removeEventListener("dispose",O),X(E),E.isVideoTexture&&g.delete(E)}function F(P){const E=P.target;E.removeEventListener("dispose",F),w(E)}function X(P){const E=r.get(P);if(E.__webglInit===void 0)return;const et=P.source,ft=x.get(et);if(ft){const pt=ft[E.__cacheKey];pt.usedTimes--,pt.usedTimes===0&&U(P),Object.keys(ft).length===0&&x.delete(et)}r.remove(P)}function U(P){const E=r.get(P);o.deleteTexture(E.__webglTexture);const et=P.source,ft=x.get(et);delete ft[E.__cacheKey],h.memory.textures--}function w(P){const E=r.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),r.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let ft=0;ft<6;ft++){if(Array.isArray(E.__webglFramebuffer[ft]))for(let pt=0;pt<E.__webglFramebuffer[ft].length;pt++)o.deleteFramebuffer(E.__webglFramebuffer[ft][pt]);else o.deleteFramebuffer(E.__webglFramebuffer[ft]);E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer[ft])}else{if(Array.isArray(E.__webglFramebuffer))for(let ft=0;ft<E.__webglFramebuffer.length;ft++)o.deleteFramebuffer(E.__webglFramebuffer[ft]);else o.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&o.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ft=0;ft<E.__webglColorRenderbuffer.length;ft++)E.__webglColorRenderbuffer[ft]&&o.deleteRenderbuffer(E.__webglColorRenderbuffer[ft]);E.__webglDepthRenderbuffer&&o.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const et=P.textures;for(let ft=0,pt=et.length;ft<pt;ft++){const ct=r.get(et[ft]);ct.__webglTexture&&(o.deleteTexture(ct.__webglTexture),h.memory.textures--),r.remove(et[ft])}r.remove(P)}let G=0;function lt(){G=0}function ot(){const P=G;return P>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+l.maxTextures),G+=1,P}function vt(P){const E=[];return E.push(P.wrapS),E.push(P.wrapT),E.push(P.wrapR||0),E.push(P.magFilter),E.push(P.minFilter),E.push(P.anisotropy),E.push(P.internalFormat),E.push(P.format),E.push(P.type),E.push(P.generateMipmaps),E.push(P.premultiplyAlpha),E.push(P.flipY),E.push(P.unpackAlignment),E.push(P.colorSpace),E.join()}function dt(P,E){const et=r.get(P);if(P.isVideoTexture&&jt(P),P.isRenderTargetTexture===!1&&P.version>0&&et.__version!==P.version){const ft=P.image;if(ft===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ft.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Mt(et,P,E);return}}i.bindTexture(o.TEXTURE_2D,et.__webglTexture,o.TEXTURE0+E)}function I(P,E){const et=r.get(P);if(P.version>0&&et.__version!==P.version){Mt(et,P,E);return}i.bindTexture(o.TEXTURE_2D_ARRAY,et.__webglTexture,o.TEXTURE0+E)}function Z(P,E){const et=r.get(P);if(P.version>0&&et.__version!==P.version){Mt(et,P,E);return}i.bindTexture(o.TEXTURE_3D,et.__webglTexture,o.TEXTURE0+E)}function Y(P,E){const et=r.get(P);if(P.version>0&&et.__version!==P.version){Rt(et,P,E);return}i.bindTexture(o.TEXTURE_CUBE_MAP,et.__webglTexture,o.TEXTURE0+E)}const Et={[Oh]:o.REPEAT,[vr]:o.CLAMP_TO_EDGE,[Ph]:o.MIRRORED_REPEAT},L={[xi]:o.NEAREST,[NS]:o.NEAREST_MIPMAP_NEAREST,[Kl]:o.NEAREST_MIPMAP_LINEAR,[wi]:o.LINEAR,[Wf]:o.LINEAR_MIPMAP_NEAREST,[xr]:o.LINEAR_MIPMAP_LINEAR},tt={[BS]:o.NEVER,[kS]:o.ALWAYS,[IS]:o.LESS,[y0]:o.LEQUAL,[FS]:o.EQUAL,[VS]:o.GEQUAL,[HS]:o.GREATER,[GS]:o.NOTEQUAL};function xt(P,E){if(E.type===ea&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===wi||E.magFilter===Wf||E.magFilter===Kl||E.magFilter===xr||E.minFilter===wi||E.minFilter===Wf||E.minFilter===Kl||E.minFilter===xr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(P,o.TEXTURE_WRAP_S,Et[E.wrapS]),o.texParameteri(P,o.TEXTURE_WRAP_T,Et[E.wrapT]),(P===o.TEXTURE_3D||P===o.TEXTURE_2D_ARRAY)&&o.texParameteri(P,o.TEXTURE_WRAP_R,Et[E.wrapR]),o.texParameteri(P,o.TEXTURE_MAG_FILTER,L[E.magFilter]),o.texParameteri(P,o.TEXTURE_MIN_FILTER,L[E.minFilter]),E.compareFunction&&(o.texParameteri(P,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(P,o.TEXTURE_COMPARE_FUNC,tt[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===xi||E.minFilter!==Kl&&E.minFilter!==xr||E.type===ea&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const et=t.get("EXT_texture_filter_anisotropic");o.texParameterf(P,et.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function yt(P,E){let et=!1;P.__webglInit===void 0&&(P.__webglInit=!0,E.addEventListener("dispose",O));const ft=E.source;let pt=x.get(ft);pt===void 0&&(pt={},x.set(ft,pt));const ct=vt(E);if(ct!==P.__cacheKey){pt[ct]===void 0&&(pt[ct]={texture:o.createTexture(),usedTimes:0},h.memory.textures++,et=!0),pt[ct].usedTimes++;const Pt=pt[P.__cacheKey];Pt!==void 0&&(pt[P.__cacheKey].usedTimes--,Pt.usedTimes===0&&U(E)),P.__cacheKey=ct,P.__webglTexture=pt[ct].texture}return et}function Q(P,E,et){return Math.floor(Math.floor(P/et)/E)}function mt(P,E,et,ft){const ct=P.updateRanges;if(ct.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,E.width,E.height,et,ft,E.data);else{ct.sort((St,zt)=>St.start-zt.start);let Pt=0;for(let St=1;St<ct.length;St++){const zt=ct[Pt],qt=ct[St],Yt=zt.start+zt.count,wt=Q(qt.start,E.width,4),ie=Q(zt.start,E.width,4);qt.start<=Yt+1&&wt===ie&&Q(qt.start+qt.count-1,E.width,4)===wt?zt.count=Math.max(zt.count,qt.start+qt.count-zt.start):(++Pt,ct[Pt]=qt)}ct.length=Pt+1;const Ut=o.getParameter(o.UNPACK_ROW_LENGTH),Gt=o.getParameter(o.UNPACK_SKIP_PIXELS),kt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,E.width);for(let St=0,zt=ct.length;St<zt;St++){const qt=ct[St],Yt=Math.floor(qt.start/4),wt=Math.ceil(qt.count/4),ie=Yt%E.width,k=Math.floor(Yt/E.width),Nt=wt,Tt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,ie),o.pixelStorei(o.UNPACK_SKIP_ROWS,k),i.texSubImage2D(o.TEXTURE_2D,0,ie,k,Nt,Tt,et,ft,E.data)}P.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,Ut),o.pixelStorei(o.UNPACK_SKIP_PIXELS,Gt),o.pixelStorei(o.UNPACK_SKIP_ROWS,kt)}}function Mt(P,E,et){let ft=o.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ft=o.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ft=o.TEXTURE_3D);const pt=yt(P,E),ct=E.source;i.bindTexture(ft,P.__webglTexture,o.TEXTURE0+et);const Pt=r.get(ct);if(ct.version!==Pt.__version||pt===!0){i.activeTexture(o.TEXTURE0+et);const Ut=Te.getPrimaries(Te.workingColorSpace),Gt=E.colorSpace===Ia?null:Te.getPrimaries(E.colorSpace),kt=E.colorSpace===Ia||Ut===Gt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);let St=C(E.image,!1,l.maxTextureSize);St=ae(E,St);const zt=u.convert(E.format,E.colorSpace),qt=u.convert(E.type);let Yt=D(E.internalFormat,zt,qt,E.colorSpace,E.isVideoTexture);xt(ft,E);let wt;const ie=E.mipmaps,k=E.isVideoTexture!==!0,Nt=Pt.__version===void 0||pt===!0,Tt=ct.dataReady,Bt=z(E,St);if(E.isDepthTexture)Yt=A(E.format===No,E.type),Nt&&(k?i.texStorage2D(o.TEXTURE_2D,1,Yt,St.width,St.height):i.texImage2D(o.TEXTURE_2D,0,Yt,St.width,St.height,0,zt,qt,null));else if(E.isDataTexture)if(ie.length>0){k&&Nt&&i.texStorage2D(o.TEXTURE_2D,Bt,Yt,ie[0].width,ie[0].height);for(let At=0,_t=ie.length;At<_t;At++)wt=ie[At],k?Tt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,wt.width,wt.height,zt,qt,wt.data):i.texImage2D(o.TEXTURE_2D,At,Yt,wt.width,wt.height,0,zt,qt,wt.data);E.generateMipmaps=!1}else k?(Nt&&i.texStorage2D(o.TEXTURE_2D,Bt,Yt,St.width,St.height),Tt&&mt(E,St,zt,qt)):i.texImage2D(o.TEXTURE_2D,0,Yt,St.width,St.height,0,zt,qt,St.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){k&&Nt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Bt,Yt,ie[0].width,ie[0].height,St.depth);for(let At=0,_t=ie.length;At<_t;At++)if(wt=ie[At],E.format!==_i)if(zt!==null)if(k){if(Tt)if(E.layerUpdates.size>0){const Ft=I_(wt.width,wt.height,E.format,E.type);for(const ne of E.layerUpdates){const De=wt.data.subarray(ne*Ft/wt.data.BYTES_PER_ELEMENT,(ne+1)*Ft/wt.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,ne,wt.width,wt.height,1,zt,De)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,wt.width,wt.height,St.depth,zt,wt.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,At,Yt,wt.width,wt.height,St.depth,0,wt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?Tt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,wt.width,wt.height,St.depth,zt,qt,wt.data):i.texImage3D(o.TEXTURE_2D_ARRAY,At,Yt,wt.width,wt.height,St.depth,0,zt,qt,wt.data)}else{k&&Nt&&i.texStorage2D(o.TEXTURE_2D,Bt,Yt,ie[0].width,ie[0].height);for(let At=0,_t=ie.length;At<_t;At++)wt=ie[At],E.format!==_i?zt!==null?k?Tt&&i.compressedTexSubImage2D(o.TEXTURE_2D,At,0,0,wt.width,wt.height,zt,wt.data):i.compressedTexImage2D(o.TEXTURE_2D,At,Yt,wt.width,wt.height,0,wt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?Tt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,wt.width,wt.height,zt,qt,wt.data):i.texImage2D(o.TEXTURE_2D,At,Yt,wt.width,wt.height,0,zt,qt,wt.data)}else if(E.isDataArrayTexture)if(k){if(Nt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Bt,Yt,St.width,St.height,St.depth),Tt)if(E.layerUpdates.size>0){const At=I_(St.width,St.height,E.format,E.type);for(const _t of E.layerUpdates){const Ft=St.data.subarray(_t*At/St.data.BYTES_PER_ELEMENT,(_t+1)*At/St.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,_t,St.width,St.height,1,zt,qt,Ft)}E.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,St.width,St.height,St.depth,zt,qt,St.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Yt,St.width,St.height,St.depth,0,zt,qt,St.data);else if(E.isData3DTexture)k?(Nt&&i.texStorage3D(o.TEXTURE_3D,Bt,Yt,St.width,St.height,St.depth),Tt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,St.width,St.height,St.depth,zt,qt,St.data)):i.texImage3D(o.TEXTURE_3D,0,Yt,St.width,St.height,St.depth,0,zt,qt,St.data);else if(E.isFramebufferTexture){if(Nt)if(k)i.texStorage2D(o.TEXTURE_2D,Bt,Yt,St.width,St.height);else{let At=St.width,_t=St.height;for(let Ft=0;Ft<Bt;Ft++)i.texImage2D(o.TEXTURE_2D,Ft,Yt,At,_t,0,zt,qt,null),At>>=1,_t>>=1}}else if(ie.length>0){if(k&&Nt){const At=Ke(ie[0]);i.texStorage2D(o.TEXTURE_2D,Bt,Yt,At.width,At.height)}for(let At=0,_t=ie.length;At<_t;At++)wt=ie[At],k?Tt&&i.texSubImage2D(o.TEXTURE_2D,At,0,0,zt,qt,wt):i.texImage2D(o.TEXTURE_2D,At,Yt,zt,qt,wt);E.generateMipmaps=!1}else if(k){if(Nt){const At=Ke(St);i.texStorage2D(o.TEXTURE_2D,Bt,Yt,At.width,At.height)}Tt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,zt,qt,St)}else i.texImage2D(o.TEXTURE_2D,0,Yt,zt,qt,St);y(E)&&_(ft),Pt.__version=ct.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function Rt(P,E,et){if(E.image.length!==6)return;const ft=yt(P,E),pt=E.source;i.bindTexture(o.TEXTURE_CUBE_MAP,P.__webglTexture,o.TEXTURE0+et);const ct=r.get(pt);if(pt.version!==ct.__version||ft===!0){i.activeTexture(o.TEXTURE0+et);const Pt=Te.getPrimaries(Te.workingColorSpace),Ut=E.colorSpace===Ia?null:Te.getPrimaries(E.colorSpace),Gt=E.colorSpace===Ia||Pt===Ut?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Gt);const kt=E.isCompressedTexture||E.image[0].isCompressedTexture,St=E.image[0]&&E.image[0].isDataTexture,zt=[];for(let _t=0;_t<6;_t++)!kt&&!St?zt[_t]=C(E.image[_t],!0,l.maxCubemapSize):zt[_t]=St?E.image[_t].image:E.image[_t],zt[_t]=ae(E,zt[_t]);const qt=zt[0],Yt=u.convert(E.format,E.colorSpace),wt=u.convert(E.type),ie=D(E.internalFormat,Yt,wt,E.colorSpace),k=E.isVideoTexture!==!0,Nt=ct.__version===void 0||ft===!0,Tt=pt.dataReady;let Bt=z(E,qt);xt(o.TEXTURE_CUBE_MAP,E);let At;if(kt){k&&Nt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Bt,ie,qt.width,qt.height);for(let _t=0;_t<6;_t++){At=zt[_t].mipmaps;for(let Ft=0;Ft<At.length;Ft++){const ne=At[Ft];E.format!==_i?Yt!==null?k?Tt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft,0,0,ne.width,ne.height,Yt,ne.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft,ie,ne.width,ne.height,0,ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft,0,0,ne.width,ne.height,Yt,wt,ne.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft,ie,ne.width,ne.height,0,Yt,wt,ne.data)}}}else{if(At=E.mipmaps,k&&Nt){At.length>0&&Bt++;const _t=Ke(zt[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Bt,ie,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(St){k?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,zt[_t].width,zt[_t].height,Yt,wt,zt[_t].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ie,zt[_t].width,zt[_t].height,0,Yt,wt,zt[_t].data);for(let Ft=0;Ft<At.length;Ft++){const De=At[Ft].image[_t].image;k?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft+1,0,0,De.width,De.height,Yt,wt,De.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft+1,ie,De.width,De.height,0,Yt,wt,De.data)}}else{k?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Yt,wt,zt[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,ie,Yt,wt,zt[_t]);for(let Ft=0;Ft<At.length;Ft++){const ne=At[Ft];k?Tt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft+1,0,0,Yt,wt,ne.image[_t]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Ft+1,ie,Yt,wt,ne.image[_t])}}}y(E)&&_(o.TEXTURE_CUBE_MAP),ct.__version=pt.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function Ct(P,E,et,ft,pt,ct){const Pt=u.convert(et.format,et.colorSpace),Ut=u.convert(et.type),Gt=D(et.internalFormat,Pt,Ut,et.colorSpace),kt=r.get(E),St=r.get(et);if(St.__renderTarget=E,!kt.__hasExternalTextures){const zt=Math.max(1,E.width>>ct),qt=Math.max(1,E.height>>ct);pt===o.TEXTURE_3D||pt===o.TEXTURE_2D_ARRAY?i.texImage3D(pt,ct,Gt,zt,qt,E.depth,0,Pt,Ut,null):i.texImage2D(pt,ct,Gt,zt,qt,0,Pt,Ut,null)}i.bindFramebuffer(o.FRAMEBUFFER,P),_e(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,ft,pt,St.__webglTexture,0,Vt(E)):(pt===o.TEXTURE_2D||pt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&pt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,ft,pt,St.__webglTexture,ct),i.bindFramebuffer(o.FRAMEBUFFER,null)}function oe(P,E,et){if(o.bindRenderbuffer(o.RENDERBUFFER,P),E.depthBuffer){const ft=E.depthTexture,pt=ft&&ft.isDepthTexture?ft.type:null,ct=A(E.stencilBuffer,pt),Pt=E.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Ut=Vt(E);_e(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Ut,ct,E.width,E.height):et?o.renderbufferStorageMultisample(o.RENDERBUFFER,Ut,ct,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,ct,E.width,E.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,Pt,o.RENDERBUFFER,P)}else{const ft=E.textures;for(let pt=0;pt<ft.length;pt++){const ct=ft[pt],Pt=u.convert(ct.format,ct.colorSpace),Ut=u.convert(ct.type),Gt=D(ct.internalFormat,Pt,Ut,ct.colorSpace),kt=Vt(E);et&&_e(E)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,kt,Gt,E.width,E.height):_e(E)?d.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,kt,Gt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,Gt,E.width,E.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Qt(P,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,P),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ft=r.get(E.depthTexture);ft.__renderTarget=E,(!ft.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),dt(E.depthTexture,0);const pt=ft.__webglTexture,ct=Vt(E);if(E.depthTexture.format===Uo)_e(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,pt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,pt,0);else if(E.depthTexture.format===No)_e(E)?d.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,pt,0,ct):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,pt,0);else throw new Error("Unknown depthTexture format")}function Le(P){const E=r.get(P),et=P.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==P.depthTexture){const ft=P.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ft){const pt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ft.removeEventListener("dispose",pt)};ft.addEventListener("dispose",pt),E.__depthDisposeCallback=pt}E.__boundDepthTexture=ft}if(P.depthTexture&&!E.__autoAllocateDepthBuffer){if(et)throw new Error("target.depthTexture not supported in Cube render targets");const ft=P.texture.mipmaps;ft&&ft.length>0?Qt(E.__webglFramebuffer[0],P):Qt(E.__webglFramebuffer,P)}else if(et){E.__webglDepthbuffer=[];for(let ft=0;ft<6;ft++)if(i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[ft]),E.__webglDepthbuffer[ft]===void 0)E.__webglDepthbuffer[ft]=o.createRenderbuffer(),oe(E.__webglDepthbuffer[ft],P,!1);else{const pt=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=E.__webglDepthbuffer[ft];o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,pt,o.RENDERBUFFER,ct)}}else{const ft=P.texture.mipmaps;if(ft&&ft.length>0?i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=o.createRenderbuffer(),oe(E.__webglDepthbuffer,P,!1);else{const pt=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,ct=E.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,ct),o.framebufferRenderbuffer(o.FRAMEBUFFER,pt,o.RENDERBUFFER,ct)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Fe(P,E,et){const ft=r.get(P);E!==void 0&&Ct(ft.__webglFramebuffer,P,P.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),et!==void 0&&Le(P)}function ge(P){const E=P.texture,et=r.get(P),ft=r.get(E);P.addEventListener("dispose",F);const pt=P.textures,ct=P.isWebGLCubeRenderTarget===!0,Pt=pt.length>1;if(Pt||(ft.__webglTexture===void 0&&(ft.__webglTexture=o.createTexture()),ft.__version=E.version,h.memory.textures++),ct){et.__webglFramebuffer=[];for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0){et.__webglFramebuffer[Ut]=[];for(let Gt=0;Gt<E.mipmaps.length;Gt++)et.__webglFramebuffer[Ut][Gt]=o.createFramebuffer()}else et.__webglFramebuffer[Ut]=o.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){et.__webglFramebuffer=[];for(let Ut=0;Ut<E.mipmaps.length;Ut++)et.__webglFramebuffer[Ut]=o.createFramebuffer()}else et.__webglFramebuffer=o.createFramebuffer();if(Pt)for(let Ut=0,Gt=pt.length;Ut<Gt;Ut++){const kt=r.get(pt[Ut]);kt.__webglTexture===void 0&&(kt.__webglTexture=o.createTexture(),h.memory.textures++)}if(P.samples>0&&_e(P)===!1){et.__webglMultisampledFramebuffer=o.createFramebuffer(),et.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,et.__webglMultisampledFramebuffer);for(let Ut=0;Ut<pt.length;Ut++){const Gt=pt[Ut];et.__webglColorRenderbuffer[Ut]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,et.__webglColorRenderbuffer[Ut]);const kt=u.convert(Gt.format,Gt.colorSpace),St=u.convert(Gt.type),zt=D(Gt.internalFormat,kt,St,Gt.colorSpace,P.isXRRenderTarget===!0),qt=Vt(P);o.renderbufferStorageMultisample(o.RENDERBUFFER,qt,zt,P.width,P.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Ut,o.RENDERBUFFER,et.__webglColorRenderbuffer[Ut])}o.bindRenderbuffer(o.RENDERBUFFER,null),P.depthBuffer&&(et.__webglDepthRenderbuffer=o.createRenderbuffer(),oe(et.__webglDepthRenderbuffer,P,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(ct){i.bindTexture(o.TEXTURE_CUBE_MAP,ft.__webglTexture),xt(o.TEXTURE_CUBE_MAP,E);for(let Ut=0;Ut<6;Ut++)if(E.mipmaps&&E.mipmaps.length>0)for(let Gt=0;Gt<E.mipmaps.length;Gt++)Ct(et.__webglFramebuffer[Ut][Gt],P,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,Gt);else Ct(et.__webglFramebuffer[Ut],P,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+Ut,0);y(E)&&_(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Pt){for(let Ut=0,Gt=pt.length;Ut<Gt;Ut++){const kt=pt[Ut],St=r.get(kt);i.bindTexture(o.TEXTURE_2D,St.__webglTexture),xt(o.TEXTURE_2D,kt),Ct(et.__webglFramebuffer,P,kt,o.COLOR_ATTACHMENT0+Ut,o.TEXTURE_2D,0),y(kt)&&_(o.TEXTURE_2D)}i.unbindTexture()}else{let Ut=o.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(Ut=P.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Ut,ft.__webglTexture),xt(Ut,E),E.mipmaps&&E.mipmaps.length>0)for(let Gt=0;Gt<E.mipmaps.length;Gt++)Ct(et.__webglFramebuffer[Gt],P,E,o.COLOR_ATTACHMENT0,Ut,Gt);else Ct(et.__webglFramebuffer,P,E,o.COLOR_ATTACHMENT0,Ut,0);y(E)&&_(Ut),i.unbindTexture()}P.depthBuffer&&Le(P)}function H(P){const E=P.textures;for(let et=0,ft=E.length;et<ft;et++){const pt=E[et];if(y(pt)){const ct=N(P),Pt=r.get(pt).__webglTexture;i.bindTexture(ct,Pt),_(ct),i.unbindTexture()}}}const xn=[],ye=[];function de(P){if(P.samples>0){if(_e(P)===!1){const E=P.textures,et=P.width,ft=P.height;let pt=o.COLOR_BUFFER_BIT;const ct=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,Pt=r.get(P),Ut=E.length>1;if(Ut)for(let kt=0;kt<E.length;kt++)i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer);const Gt=P.texture.mipmaps;Gt&&Gt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let kt=0;kt<E.length;kt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(pt|=o.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(pt|=o.STENCIL_BUFFER_BIT)),Ut){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,Pt.__webglColorRenderbuffer[kt]);const St=r.get(E[kt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,St,0)}o.blitFramebuffer(0,0,et,ft,0,0,et,ft,pt,o.NEAREST),m===!0&&(xn.length=0,ye.length=0,xn.push(o.COLOR_ATTACHMENT0+kt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(xn.push(ct),ye.push(ct),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ye)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,xn))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Ut)for(let kt=0;kt<E.length;kt++){i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.RENDERBUFFER,Pt.__webglColorRenderbuffer[kt]);const St=r.get(E[kt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,Pt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+kt,o.TEXTURE_2D,St,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&m){const E=P.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[E])}}}function Vt(P){return Math.min(l.maxSamples,P.samples)}function _e(P){const E=r.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function jt(P){const E=h.render.frame;g.get(P)!==E&&(g.set(P,E),P.update())}function ae(P,E){const et=P.colorSpace,ft=P.format,pt=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||et!==Ss&&et!==Ia&&(Te.getTransfer(et)===Ie?(ft!==_i||pt!==aa)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",et)),E}function Ke(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(p.width=P.naturalWidth||P.width,p.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(p.width=P.displayWidth,p.height=P.displayHeight):(p.width=P.width,p.height=P.height),p}this.allocateTextureUnit=ot,this.resetTextureUnits=lt,this.setTexture2D=dt,this.setTexture2DArray=I,this.setTexture3D=Z,this.setTextureCube=Y,this.rebindTextures=Fe,this.setupRenderTarget=ge,this.updateRenderTargetMipmap=H,this.updateMultisampleRenderTarget=de,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=Ct,this.useMultisampledRTT=_e}function e1(o,t){function i(r,l=Ia){let u;const h=Te.getTransfer(l);if(r===aa)return o.UNSIGNED_BYTE;if(r===gd)return o.UNSIGNED_SHORT_4_4_4_4;if(r===_d)return o.UNSIGNED_SHORT_5_5_5_1;if(r===m0)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===d0)return o.BYTE;if(r===p0)return o.SHORT;if(r===Co)return o.UNSIGNED_SHORT;if(r===md)return o.INT;if(r===Sr)return o.UNSIGNED_INT;if(r===ea)return o.FLOAT;if(r===Po)return o.HALF_FLOAT;if(r===g0)return o.ALPHA;if(r===_0)return o.RGB;if(r===_i)return o.RGBA;if(r===Uo)return o.DEPTH_COMPONENT;if(r===No)return o.DEPTH_STENCIL;if(r===v0)return o.RED;if(r===vd)return o.RED_INTEGER;if(r===x0)return o.RG;if(r===xd)return o.RG_INTEGER;if(r===Sd)return o.RGBA_INTEGER;if(r===yc||r===Mc||r===Ec||r===Tc)if(h===Ie)if(u=t.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===yc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Mc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Ec)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Tc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=t.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===yc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Mc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Ec)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Tc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===zh||r===Bh||r===Ih||r===Fh)if(u=t.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===zh)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Bh)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Ih)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Fh)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Hh||r===Gh||r===Vh)if(u=t.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Hh||r===Gh)return h===Ie?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===Vh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===kh||r===Xh||r===Wh||r===qh||r===Yh||r===jh||r===Zh||r===Kh||r===Qh||r===Jh||r===$h||r===td||r===ed||r===nd)if(u=t.get("WEBGL_compressed_texture_astc"),u!==null){if(r===kh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Xh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Wh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===qh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Yh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===jh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Zh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Kh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Qh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Jh)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===$h)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===td)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===ed)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===nd)return h===Ie?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===bc||r===id||r===ad)if(u=t.get("EXT_texture_compression_bptc"),u!==null){if(r===bc)return h===Ie?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===id)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===ad)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===S0||r===rd||r===sd||r===od)if(u=t.get("EXT_texture_compression_rgtc"),u!==null){if(r===bc)return u.COMPRESSED_RED_RGTC1_EXT;if(r===rd)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===sd)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===od)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Do?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const n1=`
void main() {
...
}`;class a1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i,r){if(this.texture===null){const l=new Vn,u=t.properties.get(l);u.__webglTexture=i.texture,(i.depthNear!==r.depthNear||i.depthFar!==r.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,r=new Va({vertexShader:n1,fragmentShader:i1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new vi(new Oc(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class r1 extends Ms{constructor(t,i){super();const r=this;let l=null,u=1,h=null,d="local-floor",m=1,p=null,g=null,v=null,x=null,M=null,b=null;const C=new a1,y=i.getContextAttributes();let _=null,N=null;const D=[],A=[],z=new be;let O=null;const F=new ti;F.viewport=new $e;const X=new ti;X.viewport=new $e;const U=[F,X],w=new Ay;let G=null,lt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let mt=D[Q];return mt===void 0&&(mt=new ph,D[Q]=mt),mt.getTargetRaySpace()},this.getControllerGrip=function(Q){let mt=D[Q];return mt===void 0&&(mt=new ph,D[Q]=mt),mt.getGripSpace()},this.getHand=function(Q){let mt=D[Q];return mt===void 0&&(mt=new ph,D[Q]=mt),mt.getHandSpace()};function ot(Q){const mt=A.indexOf(Q.inputSource);if(mt===-1)return;const Mt=D[mt];Mt!==void 0&&(Mt.update(Q.inputSource,Q.frame,p||h),Mt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function vt(){l.removeEventListener("select",ot),l.removeEventListener("selectstart",ot),l.removeEventListener("selectend",ot),l.removeEventListener("squeeze",ot),l.removeEventListener("squeezestart",ot),l.removeEventListener("squeezeend",ot),l.removeEventListener("end",vt),l.removeEventListener("inputsourceschange",dt);for(let Q=0;Q<D.length;Q++){const mt=A[Q];mt!==null&&(A[Q]=null,D[Q].disconnect(mt))}G=null,lt=null,C.reset(),t.setRenderTarget(_),M=null,x=null,v=null,l=null,N=null,yt.stop(),r.isPresenting=!1,t.setPixelRatio(O),t.setSize(z.width,z.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){u=Q,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){d=Q,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(Q){p=Q},this.getBaseLayer=function(){return x!==null?x:M},this.getBinding=function(){return v},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(Q){if(l=Q,l!==null){if(_=t.getRenderTarget(),l.addEventListener("select",ot),l.addEventListener("selectstart",ot),l.addEventListener("selectend",ot),l.addEventListener("squeeze",ot),l.addEventListener("squeezestart",ot),l.addEventListener("squeezeend",ot),l.addEventListener("end",vt),l.addEventListener("inputsourceschange",dt),y.xrCompatible!==!0&&await i.makeXRCompatible(),O=t.getPixelRatio(),t.getSize(z),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Mt=null,Rt=null,Ct=null;y.depth&&(Ct=y.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Mt=y.stencil?No:Uo,Rt=y.stencil?Do:Sr);const oe={colorFormat:i.RGBA8,depthFormat:Ct,scaleFactor:u};v=new XRWebGLBinding(l,i),x=v.createProjectionLayer(oe),l.updateRenderState({layers:[x]}),t.setPixelRatio(1),t.setSize(x.textureWidth,x.textureHeight,!1),N=new yr(x.textureWidth,x.textureHeight,{format:_i,type:aa,depthTexture:new O0(x.textureWidth,x.textureHeight,Rt,void 0,void 0,void 0,void 0,void 0,void 0,Mt),stencilBuffer:y.stencil,colorSpace:t.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const Mt={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,Mt),l.updateRenderState({baseLayer:M}),t.setPixelRatio(1),t.setSize(M.framebufferWidth,M.framebufferHeight,!1),N=new yr(M.framebufferWidth,M.framebufferHeight,{format:_i,type:aa,colorSpace:t.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}N.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),yt.setContext(l),yt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return C.getDepthTexture()};function dt(Q){for(let mt=0;mt<Q.removed.length;mt++){const Mt=Q.removed[mt],Rt=A.indexOf(Mt);Rt>=0&&(A[Rt]=null,D[Rt].disconnect(Mt))}for(let mt=0;mt<Q.added.length;mt++){const Mt=Q.added[mt];let Rt=A.indexOf(Mt);if(Rt===-1){for(let oe=0;oe<D.length;oe++)if(oe>=A.length){A.push(Mt),Rt=oe;break}else if(A[oe]===null){A[oe]=Mt,Rt=oe;break}if(Rt===-1)break}const Ct=D[Rt];Ct&&Ct.connect(Mt)}}const I=new $,Z=new $;function Y(Q,mt,Mt){I.setFromMatrixPosition(mt.matrixWorld),Z.setFromMatrixPosition(Mt.matrixWorld);const Rt=I.distanceTo(Z),Ct=mt.projectionMatrix.elements,oe=Mt.projectionMatrix.elements,Qt=Ct[14]/(Ct[10]-1),Le=Ct[14]/(Ct[10]+1),Fe=(Ct[9]+1)/Ct[5],ge=(Ct[9]-1)/Ct[5],H=(Ct[8]-1)/Ct[0],xn=(oe[8]+1)/oe[0],ye=Qt*H,de=Qt*xn,Vt=Rt/(-H+xn),_e=Vt*-H;if(mt.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(_e),Q.translateZ(Vt),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),Ct[10]===-1)Q.projectionMatrix.copy(mt.projectionMatrix),Q.projectionMatrixInverse.copy(mt.projectionMatrixInverse);else{const jt=Qt+Vt,ae=Le+Vt,Ke=ye-_e,P=de+(Rt-_e),E=Fe*Le/ae*jt,et=ge*Le/ae*jt;Q.projectionMatrix.makePerspective(Ke,P,E,et,jt,ae),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function Et(Q,mt){mt===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(mt.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(l===null)return;let mt=Q.near,Mt=Q.far;C.texture!==null&&(C.depthNear>0&&(mt=C.depthNear),C.depthFar>0&&(Mt=C.depthFar)),w.near=X.near=F.near=mt,w.far=X.far=F.far=Mt,(G!==w.near||lt!==w.far)&&(l.updateRenderState({depthNear:w.near,depthFar:w.far}),G=w.near,lt=w.far),F.layers.mask=Q.layers.mask|2,X.layers.mask=Q.layers.mask|4,w.layers.mask=F.layers.mask|X.layers.mask;const Rt=Q.parent,Ct=w.cameras;Et(w,Rt);for(let oe=0;oe<Ct.length;oe++)Et(Ct[oe],Rt);Ct.length===2?Y(w,F,X):w.projectionMatrix.copy(F.projectionMatrix),L(Q,w,Rt)};function L(Q,mt,Mt){Mt===null?Q.matrix.copy(mt.matrixWorld):(Q.matrix.copy(Mt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(mt.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(mt.projectionMatrix),Q.projectionMatrixInverse.copy(mt.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=ld*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return w},this.getFoveation=function(){if(!(x===null&&M===null))return m},this.setFoveation=function(Q){m=Q,x!==null&&(x.fixedFoveation=Q),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=Q)},this.hasDepthSensing=function(){return C.texture!==null},this.getDepthSensingMesh=function(){return C.getMesh(w)};let tt=null;function xt(Q,mt){if(g=mt.getViewerPose(p||h),b=mt,g!==null){const Mt=g.views;M!==null&&(t.setRenderTargetFramebuffer(N,M.framebuffer),t.setRenderTarget(N));let Rt=!1;Mt.length!==w.cameras.length&&(w.cameras.length=0,Rt=!0);for(let Qt=0;Qt<Mt.length;Qt++){const Le=Mt[Qt];let Fe=null;if(M!==null)Fe=M.getViewport(Le);else{const H=v.getViewSubImage(x,Le);Fe=H.viewport,Qt===0&&(t.setRenderTargetTextures(N,H.colorTexture,H.depthStencilTexture),t.setRenderTarget(N))}let ge=U[Qt];ge===void 0&&(ge=new ti,ge.layers.enable(Qt),ge.viewport=new $e,U[Qt]=ge),ge.matrix.fromArray(Le.transform.matrix),ge.matrix.decompose(ge.position,ge.quaternion,ge.scale),ge.projectionMatrix.fromArray(Le.projectionMatrix),ge.projectionMatrixInverse.copy(ge.projectionMatrix).invert(),ge.viewport.set(Fe.x,Fe.y,Fe.width,Fe.height),Qt===0&&(w.matrix.copy(ge.matrix),w.matrix.decompose(w.position,w.quaternion,w.scale)),Rt===!0&&w.cameras.push(ge)}const Ct=l.enabledFeatures;if(Ct&&Ct.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&v){const Qt=v.getDepthInformation(Mt[0]);Qt&&Qt.isValid&&Qt.texture&&C.init(t,Qt,l.renderState)}}for(let Mt=0;Mt<D.length;Mt++){const Rt=A[Mt],Ct=D[Mt];Rt!==null&&Ct!==void 0&&Ct.update(Rt,mt,p||h)}tt&&tt(Q,mt),mt.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:mt}),b=null}const yt=new P0;yt.setAnimationLoop(xt),this.setAnimationLoop=function(Q){tt=Q},this.dispose=function(){}}}const dr=new ra,s1=new Ze;function o1(o,t){function i(y,_){y.matrixAutoUpdate===!0&&y.updateMatrix(),_.value.copy(y.matrix)}function r(y,_){_.color.getRGB(y.fogColor.value,w0(o)),_.isFog?(y.fogNear.value=_.near,y.fogFar.value=_.far):_.isFogExp2&&(y.fogDensity.value=_.density)}function l(y,_,N,D,A){_.isMeshBasicMaterial||_.isMeshLambertMaterial?u(y,_):_.isMeshToonMaterial?(u(y,_),v(y,_)):_.isMeshPhongMaterial?(u(y,_),g(y,_)):_.isMeshStandardMaterial?(u(y,_),x(y,_),_.isMeshPhysicalMaterial&&M(y,_,A)):_.isMeshMatcapMaterial?(u(y,_),b(y,_)):_.isMeshDepthMaterial?u(y,_):_.isMeshDistanceMaterial?(u(y,_),C(y,_)):_.isMeshNormalMaterial?u(y,_):_.isLineBasicMaterial?(h(y,_),_.isLineDashedMaterial&&d(y,_)):_.isPointsMaterial?m(y,_,N,D):_.isSpriteMaterial?p(y,_):_.isShadowMaterial?(y.color.value.copy(_.color),y.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function u(y,_){y.opacity.value=_.opacity,_.color&&y.diffuse.value.copy(_.color),_.emissive&&y.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(y.map.value=_.map,i(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.bumpMap&&(y.bumpMap.value=_.bumpMap,i(_.bumpMap,y.bumpMapTransform),y.bumpScale.value=_.bumpScale,_.side===Gn&&(y.bumpScale.value*=-1)),_.normalMap&&(y.normalMap.value=_.normalMap,i(_.normalMap,y.normalMapTransform),y.normalScale.value.copy(_.normalScale),_.side===Gn&&y.normalScale.value.negate()),_.displacementMap&&(y.displacementMap.value=_.displacementMap,i(_.displacementMap,y.displacementMapTransform),y.displacementScale.value=_.displacementScale,y.displacementBias.value=_.displacementBias),_.emissiveMap&&(y.emissiveMap.value=_.emissiveMap,i(_.emissiveMap,y.emissiveMapTransform)),_.specularMap&&(y.specularMap.value=_.specularMap,i(_.specularMap,y.specularMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest);const N=t.get(_),D=N.envMap,A=N.envMapRotation;D&&(y.envMap.value=D,dr.copy(A),dr.x*=-1,dr.y*=-1,dr.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(dr.y*=-1,dr.z*=-1),y.envMapRotation.value.setFromMatrix4(s1.makeRotationFromEuler(dr)),y.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=_.reflectivity,y.ior.value=_.ior,y.refractionRatio.value=_.refractionRatio),_.lightMap&&(y.lightMap.value=_.lightMap,y.lightMapIntensity.value=_.lightMapIntensity,i(_.lightMap,y.lightMapTransform)),_.aoMap&&(y.aoMap.value=_.aoMap,y.aoMapIntensity.value=_.aoMapIntensity,i(_.aoMap,y.aoMapTransform))}function h(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,_.map&&(y.map.value=_.map,i(_.map,y.mapTransform))}function d(y,_){y.dashSize.value=_.dashSize,y.totalSize.value=_.dashSize+_.gapSize,y.scale.value=_.scale}function m(y,_,N,D){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.size.value=_.size*N,y.scale.value=D*.5,_.map&&(y.map.value=_.map,i(_.map,y.uvTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function p(y,_){y.diffuse.value.copy(_.color),y.opacity.value=_.opacity,y.rotation.value=_.rotation,_.map&&(y.map.value=_.map,i(_.map,y.mapTransform)),_.alphaMap&&(y.alphaMap.value=_.alphaMap,i(_.alphaMap,y.alphaMapTransform)),_.alphaTest>0&&(y.alphaTest.value=_.alphaTest)}function g(y,_){y.specular.value.copy(_.specular),y.shininess.value=Math.max(_.shininess,1e-4)}function v(y,_){_.gradientMap&&(y.gradientMap.value=_.gradientMap)}function x(y,_){y.metalness.value=_.metalness,_.metalnessMap&&(y.metalnessMap.value=_.metalnessMap,i(_.metalnessMap,y.metalnessMapTransform)),y.roughness.value=_.roughness,_.roughnessMap&&(y.roughnessMap.value=_.roughnessMap,i(_.roughnessMap,y.roughnessMapTransform)),_.envMap&&(y.envMapIntensity.value=_.envMapIntensity)}function M(y,_,N){y.ior.value=_.ior,_.sheen>0&&(y.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),y.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(y.sheenColorMap.value=_.sheenColorMap,i(_.sheenColorMap,y.sheenColorMapTransform)),_.sheenRoughnessMap&&(y.sheenRoughnessMap.value=_.sheenRoughnessMap,i(_.sheenRoughnessMap,y.sheenRoughnessMapTransform))),_.clearcoat>0&&(y.clearcoat.value=_.clearcoat,y.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(y.clearcoatMap.value=_.clearcoatMap,i(_.clearcoatMap,y.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,i(_.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(y.clearcoatNormalMap.value=_.clearcoatNormalMap,i(_.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===Gn&&y.clearcoatNormalScale.value.negate())),_.dispersion>0&&(y.dispersion.value=_.dispersion),_.iridescence>0&&(y.iridescence.value=_.iridescence,y.iridescenceIOR.value=_.iridescenceIOR,y.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(y.iridescenceMap.value=_.iridescenceMap,i(_.iridescenceMap,y.iridescenceMapTransform)),_.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=_.iridescenceThicknessMap,i(_.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),_.transmission>0&&(y.transmission.value=_.transmission,y.transmissionSamplerMap.value=N.texture,y.transmissionSamplerSize.value.set(N.width,N.height),_.transmissionMap&&(y.transmissionMap.value=_.transmissionMap,i(_.transmissionMap,y.transmissionMapTransform)),y.thickness.value=_.thickness,_.thicknessMap&&(y.thicknessMap.value=_.thicknessMap,i(_.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=_.attenuationDistance,y.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(y.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(y.anisotropyMap.value=_.anisotropyMap,i(_.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=_.specularIntensity,y.specularColor.value.copy(_.specularColor),_.specularColorMap&&(y.specularColorMap.value=_.specularColorMap,i(_.specularColorMap,y.specularColorMapTransform)),_.specularIntensityMap&&(y.specularIntensityMap.value=_.specularIntensityMap,i(_.specularIntensityMap,y.specularIntensityMapTransform))}function b(y,_){_.matcap&&(y.matcap.value=_.matcap)}function C(y,_){const N=t.get(_).light;y.referencePosition.value.setFromMatrixPosition(N.matrixWorld),y.nearDistance.value=N.shadow.camera.near,y.farDistance.value=N.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function l1(o,t,i,r){let l={},u={},h=[];const d=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(N,D){const A=D.program;r.uniformBlockBinding(N,A)}function p(N,D){let A=l[N.id];A===void 0&&(b(N),A=g(N),l[N.id]=A,N.addEventListener("dispose",y));const z=D.program;r.updateUBOMapping(N,z);const O=t.render.frame;u[N.id]!==O&&(x(N),u[N.id]=O)}function g(N){const D=v();N.__bindingPointIndex=D;const A=o.createBuffer(),z=N.__size,O=N.usage;return o.bindBuffer(o.UNIFORM_BUFFER,A),o.bufferData(o.UNIFORM_BUFFER,z,O),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,D,A),A}function v(){for(let N=0;N<d;N++)if(h.indexOf(N)===-1)return h.push(N),N;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(N){const D=l[N.id],A=N.uniforms,z=N.__cache;o.bindBuffer(o.UNIFORM_BUFFER,D);for(let O=0,F=A.length;O<F;O++){const X=Array.isArray(A[O])?A[O]:[A[O]];for(let U=0,w=X.length;U<w;U++){const G=X[U];if(M(G,O,U,z)===!0){const lt=G.__offset,ot=Array.isArray(G.value)?G.value:[G.value];let vt=0;for(let dt=0;dt<ot.length;dt++){const I=ot[dt],Z=C(I);typeof I=="number"||typeof I=="boolean"?(G.__data[0]=I,o.bufferSubData(o.UNIFORM_BUFFER,lt+vt,G.__data)):I.isMatrix3?(G.__data[0]=I.elements[0],G.__data[1]=I.elements[1],G.__data[2]=I.elements[2],G.__data[3]=0,G.__data[4]=I.elements[3],G.__data[5]=I.elements[4],G.__data[6]=I.elements[5],G.__data[7]=0,G.__data[8]=I.elements[6],G.__data[9]=I.elements[7],G.__data[10]=I.elements[8],G.__data[11]=0):(I.toArray(G.__data,vt),vt+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,lt,G.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function M(N,D,A,z){const O=N.value,F=D+"_"+A;if(z[F]===void 0)return typeof O=="number"||typeof O=="boolean"?z[F]=O:z[F]=O.clone(),!0;{const X=z[F];if(typeof O=="number"||typeof O=="boolean"){if(X!==O)return z[F]=O,!0}else if(X.equals(O)===!1)return X.copy(O),!0}return!1}function b(N){const D=N.uniforms;let A=0;const z=16;for(let F=0,X=D.length;F<X;F++){const U=Array.isArray(D[F])?D[F]:[D[F]];for(let w=0,G=U.length;w<G;w++){const lt=U[w],ot=Array.isArray(lt.value)?lt.value:[lt.value];for(let vt=0,dt=ot.length;vt<dt;vt++){const I=ot[vt],Z=C(I),Y=A%z,Et=Y%Z.boundary,L=Y+Et;A+=Et,L!==0&&z-L<Z.storage&&(A+=z-L),lt.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),lt.__offset=A,A+=Z.storage}}}const O=A%z;return O>0&&(A+=z-O),N.__size=A,N.__cache={},this}function C(N){const D={boundary:0,storage:0};return typeof N=="number"||typeof N=="boolean"?(D.boundary=4,D.storage=4):N.isVector2?(D.boundary=8,D.storage=8):N.isVector3||N.isColor?(D.boundary=16,D.storage=12):N.isVector4?(D.boundary=16,D.storage=16):N.isMatrix3?(D.boundary=48,D.storage=48):N.isMatrix4?(D.boundary=64,D.storage=64):N.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",N),D}function y(N){const D=N.target;D.removeEventListener("dispose",y);const A=h.indexOf(D.__bindingPointIndex);h.splice(A,1),o.deleteBuffer(l[D.id]),delete l[D.id],delete u[D.id]}function _(){for(const N in l)o.deleteBuffer(l[N]);h=[],l={},u={}}return{bind:m,update:p,dispose:_}}class H0{constructor(t={}){const{canvas:i=WS(),context:r=null,depth:l=!0,stencil:u=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:v=!1,reverseDepthBuffer:x=!1}=t;this.isWebGLRenderer=!0;let M;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=r.getContextAttributes().alpha}else M=h;const b=new Uint32Array(4),C=new Int32Array(4);let y=null,_=null;const N=[],D=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ha,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const A=this;let z=!1;this._outputColorSpace=ci;let O=0,F=0,X=null,U=-1,w=null;const G=new $e,lt=new $e;let ot=null;const vt=new Ce(0);let dt=0,I=i.width,Z=i.height,Y=1,Et=null,L=null;const tt=new $e(0,0,I,Z),xt=new $e(0,0,I,Z);let yt=!1;const Q=new N0;let mt=!1,Mt=!1;const Rt=new Ze,Ct=new Ze,oe=new $,Qt=new $e,Le={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Fe=!1;function ge(){return X===null?Y:1}let H=r;function xn(R,q){return i.getContext(R,q)}try{const R={alpha:!0,depth:l,stencil:u,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${pd}`),i.addEventListener("webglcontextlost",Bt,!1),i.addEventListener("webglcontextrestored",At,!1),i.addEventListener("webglcontextcreationerror",_t,!1),H===null){const q="webgl2";if(H=xn(q,R),H===null)throw xn(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let ye,de,Vt,_e,jt,ae,Ke,P,E,et,ft,pt,ct,Pt,Ut,Gt,kt,St,zt,qt,Yt,wt,ie,k;function Nt(){ye=new xT(H),ye.init(),wt=new e1(H,ye),de=new hT(H,ye,t,wt),Vt=new $b(H,ye),de.reverseDepthBuffer&&x&&Vt.buffers.depth.setReversed(!0),_e=new MT(H),jt=new Hb,ae=new t1(H,ye,Vt,jt,de,wt,_e),Ke=new pT(A),P=new vT(A),E=new wy(H),ie=new uT(H,E),et=new ST(H,E,_e,ie),ft=new TT(H,et,E,_e),zt=new ET(H,de,ae),Gt=new dT(jt),pt=new Fb(A,Ke,P,ye,de,ie,Gt),ct=new o1(A,jt),Pt=new Vb,Ut=new jb(ye),St=new cT(A,Ke,P,Vt,ft,M,m),kt=new Qb(A,ft,de),k=new l1(H,_e,de,Vt),qt=new fT(H,ye,_e),Yt=new yT(H,ye,_e),_e.programs=pt.programs,A.capabilities=de,A.extensions=ye,A.properties=jt,A.renderLists=Pt,A.shadowMap=kt,A.state=Vt,A.info=_e}Nt();const Tt=new r1(A,H);this.xr=Tt,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const R=ye.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=ye.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return Y},this.setPixelRatio=function(R){R!==void 0&&(Y=R,this.setSize(I,Z,!1))},this.getSize=function(R){return R.set(I,Z)},this.setSize=function(R,q,at=!0){if(Tt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}I=R,Z=q,i.width=Math.floor(R*Y),i.height=Math.floor(q*Y),at===!0&&(i.style.width=R+"px",i.style.height=q+"px"),this.setViewport(0,0,R,q)},this.getDrawingBufferSize=function(R){return R.set(I*Y,Z*Y).floor()},this.setDrawingBufferSize=function(R,q,at){I=R,Z=q,Y=at,i.width=Math.floor(R*at),i.height=Math.floor(q*at),this.setViewport(0,0,R,q)},this.getCurrentViewport=function(R){return R.copy(G)},this.getViewport=function(R){return R.copy(tt)},this.setViewport=function(R,q,at,rt){R.isVector4?tt.set(R.x,R.y,R.z,R.w):tt.set(R,q,at,rt),Vt.viewport(G.copy(tt).multiplyScalar(Y).round())},this.getScissor=function(R){return R.copy(xt)},this.setScissor=function(R,q,at,rt){R.isVector4?xt.set(R.x,R.y,R.z,R.w):xt.set(R,q,at,rt),Vt.scissor(lt.copy(xt).multiplyScalar(Y).round())},this.getScissorTest=function(){return yt},this.setScissorTest=function(R){Vt.setScissorTest(yt=R)},this.setOpaqueSort=function(R){Et=R},this.setTransparentSort=function(R){L=R},this.getClearColor=function(R){return R.copy(St.getClearColor())},this.setClearColor=function(){St.setClearColor(...arguments)},this.getClearAlpha=function(){return St.getClearAlpha()},this.setClearAlpha=function(){St.setClearAlpha(...arguments)},this.clear=function(R=!0,q=!0,at=!0){let rt=0;if(R){let j=!1;if(X!==null){const bt=X.texture.format;j=bt===Sd||bt===xd||bt===vd}if(j){const bt=X.texture.type,Dt=bt===aa||bt===Sr||bt===Co||bt===Do||bt===gd||bt===_d,Ot=St.getClearColor(),It=St.getClearAlpha(),te=Ot.r,Kt=Ot.g,Xt=Ot.b;Dt?(b[0]=te,b[1]=Kt,b[2]=Xt,b[3]=It,H.clearBufferuiv(H.COLOR,0,b)):(C[0]=te,C[1]=Kt,C[2]=Xt,C[3]=It,H.clearBufferiv(H.COLOR,0,C))}else rt|=H.COLOR_BUFFER_BIT}q&&(rt|=H.DEPTH_BUFFER_BIT),at&&(rt|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(rt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",Bt,!1),i.removeEventListener("webglcontextrestored",At,!1),i.removeEventListener("webglcontextcreationerror",_t,!1),St.dispose(),Pt.dispose(),Ut.dispose(),jt.dispose(),Ke.dispose(),P.dispose(),ft.dispose(),ie.dispose(),k.dispose(),pt.dispose(),Tt.dispose(),Tt.removeEventListener("sessionstart",rn),Tt.removeEventListener("sessionend",Sn),Pn.stop()};function Bt(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),z=!0}function At(){console.log("THREE.WebGLRenderer: Context Restored."),z=!1;const R=_e.autoReset,q=kt.enabled,at=kt.autoUpdate,rt=kt.needsUpdate,j=kt.type;Nt(),_e.autoReset=R,kt.enabled=q,kt.autoUpdate=at,kt.needsUpdate=rt,kt.type=j}function _t(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Ft(R){const q=R.target;q.removeEventListener("dispose",Ft),ne(q)}function ne(R){De(R),jt.remove(R)}function De(R){const q=jt.get(R).programs;q!==void 0&&(q.forEach(function(at){pt.releaseProgram(at)}),R.isShaderMaterial&&pt.releaseShaderCache(R))}this.renderBufferDirect=function(R,q,at,rt,j,bt){q===null&&(q=Le);const Dt=j.isMesh&&j.matrixWorld.determinant()<0,Ot=Wa(R,q,at,rt,j);Vt.setMaterial(rt,Dt);let It=at.index,te=1;if(rt.wireframe===!0){if(It=et.getWireframeAttribute(at),It===void 0)return;te=2}const Kt=at.drawRange,Xt=at.attributes.position;let le=Kt.start*te,Re=(Kt.start+Kt.count)*te;bt!==null&&(le=Math.max(le,bt.start*te),Re=Math.min(Re,(bt.start+bt.count)*te)),It!==null?(le=Math.max(le,0),Re=Math.min(Re,It.count)):Xt!=null&&(le=Math.max(le,0),Re=Math.min(Re,Xt.count));const Xe=Re-le;if(Xe<0||Xe===1/0)return;ie.setup(j,rt,Ot,at,It);let fe,we=qt;if(It!==null&&(fe=E.get(It),we=Yt,we.setIndex(fe)),j.isMesh)rt.wireframe===!0?(Vt.setLineWidth(rt.wireframeLinewidth*ge()),we.setMode(H.LINES)):we.setMode(H.TRIANGLES);else if(j.isLine){let Zt=rt.linewidth;Zt===void 0&&(Zt=1),Vt.setLineWidth(Zt*ge()),j.isLineSegments?we.setMode(H.LINES):j.isLineLoop?we.setMode(H.LINE_LOOP):we.setMode(H.LINE_STRIP)}else j.isPoints?we.setMode(H.POINTS):j.isSprite&&we.setMode(H.TRIANGLES);if(j.isBatchedMesh)if(j._multiDrawInstances!==null)ms("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),we.renderMultiDrawInstances(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount,j._multiDrawInstances);else if(ye.get("WEBGL_multi_draw"))we.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{const Zt=j._multiDrawStarts,Oe=j._multiDrawCounts,ve=j._multiDrawCount,hn=It?E.get(It).bytesPerElement:1,ca=jt.get(rt).currentProgram.getUniforms();for(let Ve=0;Ve<ve;Ve++)ca.setValue(H,"_gl_DrawID",Ve),we.render(Zt[Ve]/hn,Oe[Ve])}else if(j.isInstancedMesh)we.renderInstances(le,Xe,j.count);else if(at.isInstancedBufferGeometry){const Zt=at._maxInstanceCount!==void 0?at._maxInstanceCount:1/0,Oe=Math.min(at.instanceCount,Zt);we.renderInstances(le,Xe,Oe)}else we.render(le,Xe)};function Me(R,q,at){R.transparent===!0&&R.side===ta&&R.forceSinglePass===!1?(R.side=Gn,R.needsUpdate=!0,oa(R,q,at),R.side=Ga,R.needsUpdate=!0,oa(R,q,at),R.side=ta):oa(R,q,at)}this.compile=function(R,q,at=null){at===null&&(at=R),_=Ut.get(at),_.init(q),D.push(_),at.traverseVisible(function(j){j.isLight&&j.layers.test(q.layers)&&(_.pushLight(j),j.castShadow&&_.pushShadow(j))}),R!==at&&R.traverseVisible(function(j){j.isLight&&j.layers.test(q.layers)&&(_.pushLight(j),j.castShadow&&_.pushShadow(j))}),_.setupLights();const rt=new Set;return R.traverse(function(j){if(!(j.isMesh||j.isPoints||j.isLine||j.isSprite))return;const bt=j.material;if(bt)if(Array.isArray(bt))for(let Dt=0;Dt<bt.length;Dt++){const Ot=bt[Dt];Me(Ot,at,j),rt.add(Ot)}else Me(bt,at,j),rt.add(bt)}),_=D.pop(),rt},this.compileAsync=function(R,q,at=null){const rt=this.compile(R,q,at);return new Promise(j=>{function bt(){if(rt.forEach(function(Dt){jt.get(Dt).currentProgram.isReady()&&rt.delete(Dt)}),rt.size===0){j(R);return}setTimeout(bt,10)}ye.get("KHR_parallel_shader_compile")!==null?bt():setTimeout(bt,10)})};let Xn=null;function fn(R){Xn&&Xn(R)}function rn(){Pn.stop()}function Sn(){Pn.start()}const Pn=new P0;Pn.setAnimationLoop(fn),typeof self<"u"&&Pn.setContext(self),this.setAnimationLoop=function(R){Xn=R,Tt.setAnimationLoop(R),R===null?Pn.stop():Pn.start()},Tt.addEventListener("sessionstart",rn),Tt.addEventListener("sessionend",Sn),this.render=function(R,q){if(q!==void 0&&q.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(z===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),Tt.enabled===!0&&Tt.isPresenting===!0&&(Tt.cameraAutoUpdate===!0&&Tt.updateCamera(q),q=Tt.getCamera()),R.isScene===!0&&R.onBeforeRender(A,R,q,X),_=Ut.get(R,D.length),_.init(q),D.push(_),Ct.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Q.setFromProjectionMatrix(Ct),Mt=this.localClippingEnabled,mt=Gt.init(this.clippingPlanes,Mt),y=Pt.get(R,N.length),y.init(),N.push(y),Tt.enabled===!0&&Tt.isPresenting===!0){const bt=A.xr.getDepthSensingMesh();bt!==null&&ka(bt,q,-1/0,A.sortObjects)}ka(R,q,0,A.sortObjects),y.finish(),A.sortObjects===!0&&y.sort(Et,L),Fe=Tt.enabled===!1||Tt.isPresenting===!1||Tt.hasDepthSensing()===!1,Fe&&St.addToRenderList(y,R),this.info.render.frame++,mt===!0&&Gt.beginShadows();const at=_.state.shadowsArray;kt.render(at,R,q),mt===!0&&Gt.endShadows(),this.info.autoReset===!0&&this.info.reset();const rt=y.opaque,j=y.transmissive;if(_.setupLights(),q.isArrayCamera){const bt=q.cameras;if(j.length>0)for(let Dt=0,Ot=bt.length;Dt<Ot;Dt++){const It=bt[Dt];Go(rt,j,R,It)}Fe&&St.render(R);for(let Dt=0,Ot=bt.length;Dt<Ot;Dt++){const It=bt[Dt];Ho(y,R,It,It.viewport)}}else j.length>0&&Go(rt,j,R,q),Fe&&St.render(R),Ho(y,R,q);X!==null&&F===0&&(ae.updateMultisampleRenderTarget(X),ae.updateRenderTargetMipmap(X)),R.isScene===!0&&R.onAfterRender(A,R,q),ie.resetDefaultState(),U=-1,w=null,D.pop(),D.length>0?(_=D[D.length-1],mt===!0&&Gt.setGlobalState(A.clippingPlanes,_.state.camera)):_=null,N.pop(),N.length>0?y=N[N.length-1]:y=null};function ka(R,q,at,rt){if(R.visible===!1)return;if(R.layers.test(q.layers)){if(R.isGroup)at=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(q);else if(R.isLight)_.pushLight(R),R.castShadow&&_.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||Q.intersectsSprite(R)){rt&&Qt.setFromMatrixPosition(R.matrixWorld).applyMatrix4(Ct);const Dt=ft.update(R),Ot=R.material;Ot.visible&&y.push(R,Dt,Ot,at,Qt.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||Q.intersectsObject(R))){const Dt=ft.update(R),Ot=R.material;if(rt&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),Qt.copy(R.boundingSphere.center)):(Dt.boundingSphere===null&&Dt.computeBoundingSphere(),Qt.copy(Dt.boundingSphere.center)),Qt.applyMatrix4(R.matrixWorld).applyMatrix4(Ct)),Array.isArray(Ot)){const It=Dt.groups;for(let te=0,Kt=It.length;te<Kt;te++){const Xt=It[te],le=Ot[Xt.materialIndex];le&&le.visible&&y.push(R,Dt,le,at,Qt.z,Xt)}}else Ot.visible&&y.push(R,Dt,Ot,at,Qt.z,null)}}const bt=R.children;for(let Dt=0,Ot=bt.length;Dt<Ot;Dt++)ka(bt[Dt],q,at,rt)}function Ho(R,q,at,rt){const j=R.opaque,bt=R.transmissive,Dt=R.transparent;_.setupLightsView(at),mt===!0&&Gt.setGlobalState(A.clippingPlanes,at),rt&&Vt.viewport(G.copy(rt)),j.length>0&&Xa(j,q,at),bt.length>0&&Xa(bt,q,at),Dt.length>0&&Xa(Dt,q,at),Vt.buffers.depth.setTest(!0),Vt.buffers.depth.setMask(!0),Vt.buffers.color.setMask(!0),Vt.setPolygonOffset(!1)}function Go(R,q,at,rt){if((at.isScene===!0?at.overrideMaterial:null)!==null)return;_.state.transmissionRenderTarget[rt.id]===void 0&&(_.state.transmissionRenderTarget[rt.id]=new yr(1,1,{generateMipmaps:!0,type:ye.has("EXT_color_buffer_half_float")||ye.has("EXT_color_buffer_float")?Po:aa,minFilter:xr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Te.workingColorSpace}));const bt=_.state.transmissionRenderTarget[rt.id],Dt=rt.viewport||G;bt.setSize(Dt.z*A.transmissionResolutionScale,Dt.w*A.transmissionResolutionScale);const Ot=A.getRenderTarget(),It=A.getActiveCubeFace(),te=A.getActiveMipmapLevel();A.setRenderTarget(bt),A.getClearColor(vt),dt=A.getClearAlpha(),dt<1&&A.setClearColor(16777215,.5),A.clear(),Fe&&St.render(at);const Kt=A.toneMapping;A.toneMapping=Ha;const Xt=rt.viewport;if(rt.viewport!==void 0&&(rt.viewport=void 0),_.setupLightsView(rt),mt===!0&&Gt.setGlobalState(A.clippingPlanes,rt),Xa(R,at,rt),ae.updateMultisampleRenderTarget(bt),ae.updateRenderTargetMipmap(bt),ye.has("WEBGL_multisampled_render_to_texture")===!1){let le=!1;for(let Re=0,Xe=q.length;Re<Xe;Re++){const fe=q[Re],we=fe.object,Zt=fe.geometry,Oe=fe.material,ve=fe.group;if(Oe.side===ta&&we.layers.test(rt.layers)){const hn=Oe.side;Oe.side=Gn,Oe.needsUpdate=!0,sa(we,at,rt,Zt,Oe,ve),Oe.side=hn,Oe.needsUpdate=!0,le=!0}}le===!0&&(ae.updateMultisampleRenderTarget(bt),ae.updateRenderTargetMipmap(bt))}A.setRenderTarget(Ot,It,te),A.setClearColor(vt,dt),Xt!==void 0&&(rt.viewport=Xt),A.toneMapping=Kt}function Xa(R,q,at){const rt=q.isScene===!0?q.overrideMaterial:null;for(let j=0,bt=R.length;j<bt;j++){const Dt=R[j],Ot=Dt.object,It=Dt.geometry,te=Dt.group;let Kt=Dt.material;Kt.allowOverride===!0&&rt!==null&&(Kt=rt),Ot.layers.test(at.layers)&&sa(Ot,q,at,It,Kt,te)}}function sa(R,q,at,rt,j,bt){R.onBeforeRender(A,q,at,rt,j,bt),R.modelViewMatrix.multiplyMatrices(at.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),j.onBeforeRender(A,q,at,rt,R,bt),j.transparent===!0&&j.side===ta&&j.forceSinglePass===!1?(j.side=Gn,j.needsUpdate=!0,A.renderBufferDirect(at,q,rt,j,R,bt),j.side=Ga,j.needsUpdate=!0,A.renderBufferDirect(at,q,rt,j,R,bt),j.side=ta):A.renderBufferDirect(at,q,rt,j,R,bt),R.onAfterRender(A,q,at,rt,j,bt)}function oa(R,q,at){q.isScene!==!0&&(q=Le);const rt=jt.get(R),j=_.state.lights,bt=_.state.shadowsArray,Dt=j.state.version,Ot=pt.getParameters(R,j.state,bt,q,at),It=pt.getProgramCacheKey(Ot);let te=rt.programs;rt.environment=R.isMeshStandardMaterial?q.environment:null,rt.fog=q.fog,rt.envMap=(R.isMeshStandardMaterial?P:Ke).get(R.envMap||rt.environment),rt.envMapRotation=rt.environment!==null&&R.envMap===null?q.environmentRotation:R.envMapRotation,te===void 0&&(R.addEventListener("dispose",Ft),te=new Map,rt.programs=te);let Kt=te.get(It);if(Kt!==void 0){if(rt.currentProgram===Kt&&rt.lightsStateVersion===Dt)return Di(R,Ot),Kt}else Ot.uniforms=pt.getUniforms(R),R.onBeforeCompile(Ot,A),Kt=pt.acquireProgram(Ot,It),te.set(It,Kt),rt.uniforms=Ot.uniforms;const Xt=rt.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Xt.clippingPlanes=Gt.uniform),Di(R,Ot),rt.needsLights=tn(R),rt.lightsStateVersion=Dt,rt.needsLights&&(Xt.ambientLightColor.value=j.state.ambient,Xt.lightProbe.value=j.state.probe,Xt.directionalLights.value=j.state.directional,Xt.directionalLightShadows.value=j.state.directionalShadow,Xt.spotLights.value=j.state.spot,Xt.spotLightShadows.value=j.state.spotShadow,Xt.rectAreaLights.value=j.state.rectArea,Xt.ltc_1.value=j.state.rectAreaLTC1,Xt.ltc_2.value=j.state.rectAreaLTC2,Xt.pointLights.value=j.state.point,Xt.pointLightShadows.value=j.state.pointShadow,Xt.hemisphereLights.value=j.state.hemi,Xt.directionalShadowMap.value=j.state.directionalShadowMap,Xt.directionalShadowMatrix.value=j.state.directionalShadowMatrix,Xt.spotShadowMap.value=j.state.spotShadowMap,Xt.spotLightMatrix.value=j.state.spotLightMatrix,Xt.spotLightMap.value=j.state.spotLightMap,Xt.pointShadowMap.value=j.state.pointShadowMap,Xt.pointShadowMatrix.value=j.state.pointShadowMatrix),rt.currentProgram=Kt,rt.uniformsList=null,Kt}function Ci(R){if(R.uniformsList===null){const q=R.currentProgram.getUniforms();R.uniformsList=Ac.seqWithValue(q.seq,R.uniforms)}return R.uniformsList}function Di(R,q){const at=jt.get(R);at.outputColorSpace=q.outputColorSpace,at.batching=q.batching,at.batchingColor=q.batchingColor,at.instancing=q.instancing,at.instancingColor=q.instancingColor,at.instancingMorph=q.instancingMorph,at.skinning=q.skinning,at.morphTargets=q.morphTargets,at.morphNormals=q.morphNormals,at.morphColors=q.morphColors,at.morphTargetsCount=q.morphTargetsCount,at.numClippingPlanes=q.numClippingPlanes,at.numIntersection=q.numClipIntersection,at.vertexAlphas=q.vertexAlphas,at.vertexTangents=q.vertexTangents,at.toneMapping=q.toneMapping}function Wa(R,q,at,rt,j){q.isScene!==!0&&(q=Le),ae.resetTextureUnits();const bt=q.fog,Dt=rt.isMeshStandardMaterial?q.environment:null,Ot=X===null?A.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:Ss,It=(rt.isMeshStandardMaterial?P:Ke).get(rt.envMap||Dt),te=rt.vertexColors===!0&&!!at.attributes.color&&at.attributes.color.itemSize===4,Kt=!!at.attributes.tangent&&(!!rt.normalMap||rt.anisotropy>0),Xt=!!at.morphAttributes.position,le=!!at.morphAttributes.normal,Re=!!at.morphAttributes.color;let Xe=Ha;rt.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(Xe=A.toneMapping);const fe=at.morphAttributes.position||at.morphAttributes.normal||at.morphAttributes.color,we=fe!==void 0?fe.length:0,Zt=jt.get(rt),Oe=_.state.lights;if(mt===!0&&(Mt===!0||R!==w)){const dn=R===w&&rt.id===U;Gt.setState(rt,R,dn)}let ve=!1;rt.version===Zt.__version?(Zt.needsLights&&Zt.lightsStateVersion!==Oe.state.version||Zt.outputColorSpace!==Ot||j.isBatchedMesh&&Zt.batching===!1||!j.isBatchedMesh&&Zt.batching===!0||j.isBatchedMesh&&Zt.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Zt.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Zt.instancing===!1||!j.isInstancedMesh&&Zt.instancing===!0||j.isSkinnedMesh&&Zt.skinning===!1||!j.isSkinnedMesh&&Zt.skinning===!0||j.isInstancedMesh&&Zt.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Zt.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Zt.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Zt.instancingMorph===!1&&j.morphTexture!==null||Zt.envMap!==It||rt.fog===!0&&Zt.fog!==bt||Zt.numClippingPlanes!==void 0&&(Zt.numClippingPlanes!==Gt.numPlanes||Zt.numIntersection!==Gt.numIntersection)||Zt.vertexAlphas!==te||Zt.vertexTangents!==Kt||Zt.morphTargets!==Xt||Zt.morphNormals!==le||Zt.morphColors!==Re||Zt.toneMapping!==Xe||Zt.morphTargetsCount!==we)&&(ve=!0):(ve=!0,Zt.__version=rt.version);let hn=Zt.currentProgram;ve===!0&&(hn=oa(rt,q,j));let ca=!1,Ve=!1,Ni=!1;const He=hn.getUniforms(),bn=Zt.uniforms;if(Vt.useProgram(hn.program)&&(ca=!0,Ve=!0,Ni=!0),rt.id!==U&&(U=rt.id,Ve=!0),ca||w!==R){Vt.buffers.depth.getReversed()?(Rt.copy(R.projectionMatrix),YS(Rt),jS(Rt),He.setValue(H,"projectionMatrix",Rt)):He.setValue(H,"projectionMatrix",R.projectionMatrix),He.setValue(H,"viewMatrix",R.matrixWorldInverse);const yn=He.map.cameraPosition;yn!==void 0&&yn.setValue(H,oe.setFromMatrixPosition(R.matrixWorld)),de.logarithmicDepthBuffer&&He.setValue(H,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(rt.isMeshPhongMaterial||rt.isMeshToonMaterial||rt.isMeshLambertMaterial||rt.isMeshBasicMaterial||rt.isMeshStandardMaterial||rt.isShaderMaterial)&&He.setValue(H,"isOrthographic",R.isOrthographicCamera===!0),w!==R&&(w=R,Ve=!0,Ni=!0)}if(j.isSkinnedMesh){He.setOptional(H,j,"bindMatrix"),He.setOptional(H,j,"bindMatrixInverse");const dn=j.skeleton;dn&&(dn.boneTexture===null&&dn.computeBoneTexture(),He.setValue(H,"boneTexture",dn.boneTexture,ae))}j.isBatchedMesh&&(He.setOptional(H,j,"batchingTexture"),He.setValue(H,"batchingTexture",j._matricesTexture,ae),He.setOptional(H,j,"batchingIdTexture"),He.setValue(H,"batchingIdTexture",j._indirectTexture,ae),He.setOptional(H,j,"batchingColorTexture"),j._colorsTexture!==null&&He.setValue(H,"batchingColorTexture",j._colorsTexture,ae));const sn=at.morphAttributes;if((sn.position!==void 0||sn.normal!==void 0||sn.color!==void 0)&&zt.update(j,at,hn),(Ve||Zt.receiveShadow!==j.receiveShadow)&&(Zt.receiveShadow=j.receiveShadow,He.setValue(H,"receiveShadow",j.receiveShadow)),rt.isMeshGouraudMaterial&&rt.envMap!==null&&(bn.envMap.value=It,bn.flipEnvMap.value=It.isCubeTexture&&It.isRenderTargetTexture===!1?-1:1),rt.isMeshStandardMaterial&&rt.envMap===null&&q.environment!==null&&(bn.envMapIntensity.value=q.environmentIntensity),Ve&&(He.setValue(H,"toneMappingExposure",A.toneMappingExposure),Zt.needsLights&&la(bn,Ni),bt&&rt.fog===!0&&ct.refreshFogUniforms(bn,bt),ct.refreshMaterialUniforms(bn,rt,Y,Z,_.state.transmissionRenderTarget[R.id]),Ac.upload(H,Ci(Zt),bn,ae)),rt.isShaderMaterial&&rt.uniformsNeedUpdate===!0&&(Ac.upload(H,Ci(Zt),bn,ae),rt.uniformsNeedUpdate=!1),rt.isSpriteMaterial&&He.setValue(H,"center",j.center),He.setValue(H,"modelViewMatrix",j.modelViewMatrix),He.setValue(H,"normalMatrix",j.normalMatrix),He.setValue(H,"modelMatrix",j.matrixWorld),rt.isShaderMaterial||rt.isRawShaderMaterial){const dn=rt.uniformsGroups;for(let yn=0,yi=dn.length;yn<yi;yn++){const Li=dn[yn];k.update(Li,hn),k.bind(Li,hn)}}return hn}function la(R,q){R.ambientLightColor.needsUpdate=q,R.lightProbe.needsUpdate=q,R.directionalLights.needsUpdate=q,R.directionalLightShadows.needsUpdate=q,R.pointLights.needsUpdate=q,R.pointLightShadows.needsUpdate=q,R.spotLights.needsUpdate=q,R.spotLightShadows.needsUpdate=q,R.rectAreaLights.needsUpdate=q,R.hemisphereLights.needsUpdate=q}function tn(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(R,q,at){const rt=jt.get(R);rt.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,rt.__autoAllocateDepthBuffer===!1&&(rt.__useRenderToTexture=!1),jt.get(R.texture).__webglTexture=q,jt.get(R.depthTexture).__webglTexture=rt.__autoAllocateDepthBuffer?void 0:at,rt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,q){const at=jt.get(R);at.__webglFramebuffer=q,at.__useDefaultFramebuffer=q===void 0};const Vo=H.createFramebuffer();this.setRenderTarget=function(R,q=0,at=0){X=R,O=q,F=at;let rt=!0,j=null,bt=!1,Dt=!1;if(R){const It=jt.get(R);if(It.__useDefaultFramebuffer!==void 0)Vt.bindFramebuffer(H.FRAMEBUFFER,null),rt=!1;else if(It.__webglFramebuffer===void 0)ae.setupRenderTarget(R);else if(It.__hasExternalTextures)ae.rebindTextures(R,jt.get(R.texture).__webglTexture,jt.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const Xt=R.depthTexture;if(It.__boundDepthTexture!==Xt){if(Xt!==null&&jt.has(Xt)&&(R.width!==Xt.image.width||R.height!==Xt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ae.setupDepthRenderbuffer(R)}}const te=R.texture;(te.isData3DTexture||te.isDataArrayTexture||te.isCompressedArrayTexture)&&(Dt=!0);const Kt=jt.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(Kt[q])?j=Kt[q][at]:j=Kt[q],bt=!0):R.samples>0&&ae.useMultisampledRTT(R)===!1?j=jt.get(R).__webglMultisampledFramebuffer:Array.isArray(Kt)?j=Kt[at]:j=Kt,G.copy(R.viewport),lt.copy(R.scissor),ot=R.scissorTest}else G.copy(tt).multiplyScalar(Y).floor(),lt.copy(xt).multiplyScalar(Y).floor(),ot=yt;if(at!==0&&(j=Vo),Vt.bindFramebuffer(H.FRAMEBUFFER,j)&&rt&&Vt.drawBuffers(R,j),Vt.viewport(G),Vt.scissor(lt),Vt.setScissorTest(ot),bt){const It=jt.get(R.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+q,It.__webglTexture,at)}else if(Dt){const It=jt.get(R.texture),te=q;H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,It.__webglTexture,at,te)}else if(R!==null&&at!==0){const It=jt.get(R.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,It.__webglTexture,at)}U=-1},this.readRenderTargetPixels=function(R,q,at,rt,j,bt,Dt,Ot=0){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let It=jt.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Dt!==void 0&&(It=It[Dt]),It){Vt.bindFramebuffer(H.FRAMEBUFFER,It);try{const te=R.textures[Ot],Kt=te.format,Xt=te.type;if(!de.textureFormatReadable(Kt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!de.textureTypeReadable(Xt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=R.width-rt&&at>=0&&at<=R.height-j&&(R.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+Ot),H.readPixels(q,at,rt,j,wt.convert(Kt),wt.convert(Xt),bt))}finally{const te=X!==null?jt.get(X).__webglFramebuffer:null;Vt.bindFramebuffer(H.FRAMEBUFFER,te)}}},this.readRenderTargetPixelsAsync=async function(R,q,at,rt,j,bt,Dt,Ot=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let It=jt.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Dt!==void 0&&(It=It[Dt]),It)if(q>=0&&q<=R.width-rt&&at>=0&&at<=R.height-j){Vt.bindFramebuffer(H.FRAMEBUFFER,It);const te=R.textures[Ot],Kt=te.format,Xt=te.type;if(!de.textureFormatReadable(Kt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!de.textureTypeReadable(Xt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const le=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,le),H.bufferData(H.PIXEL_PACK_BUFFER,bt.byteLength,H.STREAM_READ),R.textures.length>1&&H.readBuffer(H.COLOR_ATTACHMENT0+Ot),H.readPixels(q,at,rt,j,wt.convert(Kt),wt.convert(Xt),0);const Re=X!==null?jt.get(X).__webglFramebuffer:null;Vt.bindFramebuffer(H.FRAMEBUFFER,Re);const Xe=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await qS(H,Xe,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,le),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,bt),H.deleteBuffer(le),H.deleteSync(Xe),bt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,q=null,at=0){const rt=Math.pow(2,-at),j=Math.floor(R.image.width*rt),bt=Math.floor(R.image.height*rt),Dt=q!==null?q.x:0,Ot=q!==null?q.y:0;ae.setTexture2D(R,0),H.copyTexSubImage2D(H.TEXTURE_2D,at,0,0,Dt,Ot,j,bt),Vt.unbindTexture()};const ko=H.createFramebuffer(),Ui=H.createFramebuffer();this.copyTextureToTexture=function(R,q,at=null,rt=null,j=0,bt=null){bt===null&&(j!==0?(ms("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),bt=j,j=0):bt=0);let Dt,Ot,It,te,Kt,Xt,le,Re,Xe;const fe=R.isCompressedTexture?R.mipmaps[bt]:R.image;if(at!==null)Dt=at.max.x-at.min.x,Ot=at.max.y-at.min.y,It=at.isBox3?at.max.z-at.min.z:1,te=at.min.x,Kt=at.min.y,Xt=at.isBox3?at.min.z:0;else{const sn=Math.pow(2,-j);Dt=Math.floor(fe.width*sn),Ot=Math.floor(fe.height*sn),R.isDataArrayTexture?It=fe.depth:R.isData3DTexture?It=Math.floor(fe.depth*sn):It=1,te=0,Kt=0,Xt=0}rt!==null?(le=rt.x,Re=rt.y,Xe=rt.z):(le=0,Re=0,Xe=0);const we=wt.convert(q.format),Zt=wt.convert(q.type);let Oe;q.isData3DTexture?(ae.setTexture3D(q,0),Oe=H.TEXTURE_3D):q.isDataArrayTexture||q.isCompressedArrayTexture?(ae.setTexture2DArray(q,0),Oe=H.TEXTURE_2D_ARRAY):(ae.setTexture2D(q,0),Oe=H.TEXTURE_2D),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,q.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,q.unpackAlignment);const ve=H.getParameter(H.UNPACK_ROW_LENGTH),hn=H.getParameter(H.UNPACK_IMAGE_HEIGHT),ca=H.getParameter(H.UNPACK_SKIP_PIXELS),Ve=H.getParameter(H.UNPACK_SKIP_ROWS),Ni=H.getParameter(H.UNPACK_SKIP_IMAGES);H.pixelStorei(H.UNPACK_ROW_LENGTH,fe.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,fe.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,te),H.pixelStorei(H.UNPACK_SKIP_ROWS,Kt),H.pixelStorei(H.UNPACK_SKIP_IMAGES,Xt);const He=R.isDataArrayTexture||R.isData3DTexture,bn=q.isDataArrayTexture||q.isData3DTexture;if(R.isDepthTexture){const sn=jt.get(R),dn=jt.get(q),yn=jt.get(sn.__renderTarget),yi=jt.get(dn.__renderTarget);Vt.bindFramebuffer(H.READ_FRAMEBUFFER,yn.__webglFramebuffer),Vt.bindFramebuffer(H.DRAW_FRAMEBUFFER,yi.__webglFramebuffer);for(let Li=0;Li<It;Li++)He&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,jt.get(R).__webglTexture,j,Xt+Li),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,jt.get(q).__webglTexture,bt,Xe+Li)),H.blitFramebuffer(te,Kt,Dt,Ot,le,Re,Dt,Ot,H.DEPTH_BUFFER_BIT,H.NEAREST);Vt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Vt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(j!==0||R.isRenderTargetTexture||jt.has(R)){const sn=jt.get(R),dn=jt.get(q);Vt.bindFramebuffer(H.READ_FRAMEBUFFER,ko),Vt.bindFramebuffer(H.DRAW_FRAMEBUFFER,Ui);for(let yn=0;yn<It;yn++)He?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,sn.__webglTexture,j,Xt+yn):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,sn.__webglTexture,j),bn?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,dn.__webglTexture,bt,Xe+yn):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,dn.__webglTexture,bt),j!==0?H.blitFramebuffer(te,Kt,Dt,Ot,le,Re,Dt,Ot,H.COLOR_BUFFER_BIT,H.NEAREST):bn?H.copyTexSubImage3D(Oe,bt,le,Re,Xe+yn,te,Kt,Dt,Ot):H.copyTexSubImage2D(Oe,bt,le,Re,te,Kt,Dt,Ot);Vt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Vt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else bn?R.isDataTexture||R.isData3DTexture?H.texSubImage3D(Oe,bt,le,Re,Xe,Dt,Ot,It,we,Zt,fe.data):q.isCompressedArrayTexture?H.compressedTexSubImage3D(Oe,bt,le,Re,Xe,Dt,Ot,It,we,fe.data):H.texSubImage3D(Oe,bt,le,Re,Xe,Dt,Ot,It,we,Zt,fe):R.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,bt,le,Re,Dt,Ot,we,Zt,fe.data):R.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,bt,le,Re,fe.width,fe.height,we,fe.data):H.texSubImage2D(H.TEXTURE_2D,bt,le,Re,Dt,Ot,we,Zt,fe);H.pixelStorei(H.UNPACK_ROW_LENGTH,ve),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,hn),H.pixelStorei(H.UNPACK_SKIP_PIXELS,ca),H.pixelStorei(H.UNPACK_SKIP_ROWS,Ve),H.pixelStorei(H.UNPACK_SKIP_IMAGES,Ni),bt===0&&q.generateMipmaps&&H.generateMipmap(Oe),Vt.unbindTexture()},this.copyTextureToTexture3D=function(R,q,at=null,rt=null,j=0){return ms('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(R,q,at,rt,j)},this.initRenderTarget=function(R){jt.get(R).__webglFramebuffer===void 0&&ae.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?ae.setTextureCube(R,0):R.isData3DTexture?ae.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?ae.setTexture2DArray(R,0):ae.setTexture2D(R,0),Vt.unbindTexture()},this.resetState=function(){O=0,F=0,X=null,Vt.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return na}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Te._getDrawingBufferColorSpace(t),i.unpackColorSpace=Te._getUnpackColorSpace()}}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const B1=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],I1=On("x",B1),F1=()=>{const o=document.createElement("script");o.async=!0,o.src="https://www.googletagmanager.com/gtag/js?id=AW-1029418216",document.head.appendChild(o),window.dataLayer=window.dataLayer||[];function t(){window.dataLayer.push(arguments)}t("js",new Date),t("config","AW-1029418216"),window.gtag=t},H1=()=>{const o=vn.useRef(null),t=vn.useRef(null),i=vn.useRef(null),r=vn.useRef(null);return vn.useEffect(()=>{if(console.log("3D Component mounting landscape...",o.current),!o.current){console.log("No mount ref found");return}const l=new U0,u=new ti(75,window.innerWidth/window.innerHeight,.1,1e3),h=new H0({alpha:!0,antialias:!0});h.setSize(window.innerWidth,window.innerHeight),h.setClearColor(0,0),o.current.appendChild(h.domElement),t.current=l,i.current=h;const d=new Ro,m=new Ed({color:6717162,transparent:!0,opacity:.1});for(let A=-10;A<=10;A+=2){const z=new Ln().setFromPoints([new $(-10,-2,A),new $(10,-2,A)]),O=new cd(z,m);d.add(O)}for(let A=-10;A<=10;A+=2){const z=new Ln().setFromPoints([new $(A,-2,-10),new $(A,-2,10)]),O=new cd(z,m);d.add(O)}l.add(d);const p=[],g=[new Ts(.2,.2,.2),new Td(.15),new Ad(.18)],v=new Lo({color:7752610,transparent:!0,opacity:.15,wireframe:!0});for(let A=0;A<15;A++){const z=g[Math.floor(Math.random()*g.length)],O=new vi(z,v);O.position.x=(Math.random()-.5)*20,O.position.y=Math.random()*5-1,O.position.z=(Math.random()-.5)*20,O.userData={originalPosition:O.position.clone(),rotationSpeed:{x:(Math.random()-.5)*.02,y:(Math.random()-.5)*.02,z:(Math.random()-.5)*.02},floatPhase:Math.random()*Math.PI*2},l.add(O),p.push(O)}const x=new Ln,M=50,b=new Float32Array(M*3),C=[];for(let A=0;A<M;A++)b[A*3]=(Math.random()-.5)*20,b[A*3+1]=Math.random()*3,b[A*3+2]=(Math.random()-.5)*20,C.push({x:(Math.random()-.5)*.02,y:(Math.random()-.5)*.01,z:(Math.random()-.5)*.02});x.setAttribute("position",new Si(b,3));const y=new L0({color:6717162,size:.05,transparent:!0,opacity:.6}),_=new My(x,y);l.add(_),u.position.set(0,3,8),u.lookAt(0,0,0);const N=()=>{const A=Date.now()*.001;d.rotation.y=A*.05,d.position.y=Math.sin(A*.5)*.1-2,p.forEach(O=>{O.rotation.x+=O.userData.rotationSpeed.x,O.rotation.y+=O.userData.rotationSpeed.y,O.rotation.z+=O.userData.rotationSpeed.z,O.position.y=O.userData.originalPosition.y+Math.sin(A+O.userData.floatPhase)*.3});const z=_.geometry.attributes.position.array;for(let O=0;O<M;O++)z[O*3]+=C[O].x,z[O*3+1]+=C[O].y,z[O*3+2]+=C[O].z,Math.abs(z[O*3])>10&&(z[O*3]*=-1),Math.abs(z[O*3+2])>10&&(z[O*3+2]*=-1),z[O*3+1]>5&&(z[O*3+1]=-2),z[O*3+1]<-3&&(z[O*3+1]=5);_.geometry.attributes.position.needsUpdate=!0,u.position.y=3+Math.sin(A*.3)*.2,u.lookAt(0,Math.sin(A*.2)*.1,0),h.render(l,u),r.current=requestAnimationFrame(N)};N();const D=()=>{u.aspect=window.innerWidth/window.innerHeight,u.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",D),()=>{window.removeEventListener("resize",D),r.current&&cancelAnimationFrame(r.current),o.current&&h.domElement&&o.current.removeChild(h.domElement),h.dispose()}},[]),st.jsx("div",{ref:o,className:"fixed inset-0 z-0",style:{pointerEvents:"none",opacity:.3}})},G1=()=>{const o=vn.useRef(null),t=vn.useRef(null),i=vn.useRef(null),r=vn.useRef(null);return vn.useEffect(()=>{if(console.log("3D Component mounting 3d network...",o.current),!o.current){console.log("No mount ref found");return}const l=new U0,u=new ti(75,window.innerWidth/window.innerHeight,.1,1e3),h=new H0({alpha:!0,antialias:!0});h.setSize(window.innerWidth,window.innerHeight),h.setClearColor(0,0),o.current.appendChild(h.domElement),t.current=l,i.current=h;const d=[],m=[],p=25,g=new bd(.03,16,16),v=new Lo({color:6717162,transparent:!0,opacity:.8}),x=new Lo({color:7752610,transparent:!0,opacity:1});for(let N=0;N<p;N++){const D=new vi(g,Math.random()>.8?x:v),A=3+Math.random()*4,z=N/p*Math.PI*2+Math.random()*.5,O=Math.random()*Math.PI;D.position.x=A*Math.sin(O)*Math.cos(z),D.position.y=A*Math.sin(O)*Math.sin(z),D.position.z=A*Math.cos(O),D.userData={originalPosition:D.position.clone(),pulsePhase:Math.random()*Math.PI*2,isPulse:D.material===x},l.add(D),d.push(D)}const M=new Ed({color:6717162,transparent:!0,opacity:.3});for(let N=0;N<d.length;N++)for(let D=N+1;D<d.length;D++)if(d[N].position.distanceTo(d[D].position)<2.5&&Math.random()>.7){const z=new Ln().setFromPoints([d[N].position,d[D].position]),O=new cd(z,M);l.add(O),m.push({line:O,nodeA:d[N],nodeB:d[D],pulsePhase:Math.random()*Math.PI*2})}u.position.z=8,u.position.y=1;const b=new be,C=N=>{b.x=N.clientX/window.innerWidth*2-1,b.y=-(N.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",C);const y=()=>{const N=Date.now()*.001;l.rotation.y=N*.1,l.rotation.x=Math.sin(N*.05)*.1,d.forEach((D,A)=>{if(D.position.y=D.userData.originalPosition.y+Math.sin(N+A)*.1,D.position.x=D.userData.originalPosition.x+Math.cos(N+A*.5)*.05,D.userData.isPulse){const z=1+Math.sin(N*3+D.userData.pulsePhase)*.3;D.scale.setScalar(z),D.material.opacity=.7+Math.sin(N*2+D.userData.pulsePhase)*.3}}),m.forEach(D=>{const{line:A,nodeA:z,nodeB:O}=D,F=A.geometry.attributes.position.array;F[0]=z.position.x,F[1]=z.position.y,F[2]=z.position.z,F[3]=O.position.x,F[4]=O.position.y,F[5]=O.position.z,A.geometry.attributes.position.needsUpdate=!0,A.material.opacity=.2+Math.sin(N*2+D.pulsePhase)*.1}),u.position.x+=(b.x*.5-u.position.x)*.05,u.position.y+=(b.y*.5-u.position.y)*.05,u.lookAt(l.position),h.render(l,u),r.current=requestAnimationFrame(y)};y();const _=()=>{u.aspect=window.innerWidth/window.innerHeight,u.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",_),()=>{window.removeEventListener("mousemove",C),window.removeEventListener("resize",_),r.current&&cancelAnimationFrame(r.current),o.current&&h.domElement&&o.current.removeChild(h.domElement),h.dispose()}},[]),st.jsx("div",{ref:o,className:"absolute inset-0 z-0",style:{pointerEvents:"none",opacity:.6}})},V1=()=>{const[o,t]=vn.useState(!1),i=()=>{window.gtag&&window.gtag("event","conversion",{send_to:"AW-1029418216/rcu4CPmQ2O0aEOjZ7uoD"})};return st.jsx("header",{className:"fixed top-0 w-full z-50 bg-white/10 backdrop-blur-xl border-b border-white/20",children:st.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[st.jsxs("div",{className:"flex justify-between items-center h-16",children:[st.jsx("div",{className:"flex items-center",children:st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx("div",{className:"w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center",children:st.jsx(zc,{className:"w-5 h-5 text-white"})}),st.jsx("span",{className:"text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent",children:"TecnoSoluciones"})]})}),st.jsxs("div",{className:"hidden md:flex items-center space-x-6",children:[st.jsxs("div",{className:"flex items-center space-x-2 text-gray-700",children:[st.jsx(hd,{className:"w-4 h-4"}),st.jsx("span",{className:"text-sm",children:"tecnosolucionesuno@gmail.com"})]}),st.jsxs("a",{href:"https://wa.me/5491134227461",onClick:i,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl",children:[st.jsx(Oo,{className:"w-4 h-4"}),st.jsx("span",{children:"WhatsApp"})]})]}),st.jsx("div",{className:"md:hidden",children:st.jsx("button",{onClick:()=>t(!o),className:"text-gray-700 hover:text-gray-900",children:o?st.jsx(I1,{className:"w-6 h-6"}):st.jsx(T1,{className:"w-6 h-6"})})})]}),o&&st.jsx("div",{className:"md:hidden py-4 border-t border-white/20",children:st.jsxs("div",{className:"flex flex-col space-y-4",children:[st.jsxs("div",{className:"flex items-center space-x-2 text-gray-700",children:[st.jsx(hd,{className:"w-4 h-4"}),st.jsx("span",{className:"text-sm",children:"tecnosolucionesuno@gmail.com"})]}),st.jsxs("a",{href:"https://wa.me/5491134227461",onClick:i,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center space-x-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-all duration-300 w-fit",children:[st.jsx(Oo,{className:"w-4 h-4"}),st.jsx("span",{children:"WhatsApp"})]})]})})]})})},k1=()=>{const o=()=>{window.gtag&&window.gtag("event","conversion",{send_to:"AW-1029418216/GU-ICPaQ2O0aEOjZ7uoD"}),document.getElementById("servicios")?.scrollIntoView({behavior:"smooth"})};return st.jsxs("section",{className:"relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50",children:[st.jsx(H1,{}),st.jsx(G1,{}),st.jsxs("div",{className:"absolute inset-0 overflow-hidden",children:[st.jsx("div",{className:"absolute -top-40 -right-40 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"}),st.jsx("div",{className:"absolute -bottom-40 -left-40 w-80 h-80 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse delay-75"}),st.jsx("div",{className:"absolute top-40 left-40 w-80 h-80 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse delay-150"})]}),st.jsx("div",{className:"relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center",children:st.jsxs("div",{className:"space-y-8",children:[st.jsxs("div",{className:"inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-4 py-2 text-sm text-gray-700",children:[st.jsx(zc,{className:"w-4 h-4 text-purple-600"}),st.jsx("span",{children:"+20 años de experiencia comprobada"})]}),st.jsxs("h1",{className:"text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight",children:["Potenciá tu negocio con"," ",st.jsx("span",{className:"bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent",children:"Marketing Digital"})]}),st.jsx("p",{className:"text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed",children:"Soluciones tecnológicas integrales que transforman empresas y maximizan resultados."}),st.jsx("div",{className:"text-lg text-gray-500 max-w-2xl mx-auto",children:"Especialistas en publicidad digital, con más de 20 años de experiencia comprobada."}),st.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 justify-center items-center",children:[st.jsxs("button",{onClick:o,className:"group inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl",children:[st.jsx("span",{className:"font-semibold",children:"Descubre nuestros servicios"}),st.jsx(m1,{className:"w-5 h-5 group-hover:translate-x-1 transition-transform"})]}),st.jsxs("a",{href:"https://wa.me/5491134227461",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm border border-white/30 hover:bg-white/30 text-gray-700 px-8 py-4 rounded-full transition-all duration-300",children:[st.jsx(Oo,{className:"w-5 h-5"}),st.jsx("span",{className:"font-semibold",children:"Consulta gratuita"})]})]})]})})]})},X1=({icon:o,title:t,description:i,features:r,gradient:l,delay:u})=>{const h=o;return st.jsxs("div",{className:"group relative bg-white/60 backdrop-blur-lg border border-white/20 rounded-3xl p-8 hover:bg-white/80 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl",style:{animationDelay:`${u}ms`},children:[st.jsx("div",{className:`inline-flex items-center justify-center w-16 h-16 ${l} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`,children:st.jsx(h,{className:"w-8 h-8 text-white"})}),st.jsx("h3",{className:"text-2xl font-bold text-gray-900 mb-4",children:t}),st.jsx("p",{className:"text-gray-600 mb-6 leading-relaxed",children:i}),st.jsx("ul",{className:"space-y-3",children:r.map((d,m)=>st.jsxs("li",{className:"flex items-start space-x-3",children:[st.jsx(V0,{className:"w-5 h-5 text-green-500 mt-0.5 flex-shrink-0"}),st.jsx("span",{className:"text-gray-700",children:d})]},m))})]})},W1=()=>{const o=[{icon:N1,title:"Marketing Digital",description:"Hacé crecer tu negocio con campañas publicitarias que realmente funcionan y generan resultados medibles.",gradient:"bg-gradient-to-br from-blue-500 to-purple-600",features:["Estrategias personalizadas para tu sector","Gestión completa de redes sociales","Publicidad en Google y Facebook Ads","Análisis de resultados y optimización continua","Aumento comprobado en ventas","ROI garantizado"]},{icon:z1,title:"Soporte Técnico",description:"Reparación, actualización e instalación profesional para tu PC o Notebook con garantía total.",gradient:"bg-gradient-to-br from-green-500 to-teal-600",features:["Diagnóstico gratuito y detallado","Soluciones rápidas y efectivas","Reparación de hardware y software","Actualizaciones de sistemas","Instalación de programas especializados","Soporte remoto 24/7"]},{icon:_1,title:"Inteligencia Artificial",description:"Tutorías personalizadas para implementar IA en tu negocio y automatizar procesos clave.",gradient:"bg-gradient-to-br from-purple-500 to-pink-600",features:["Automatización de procesos empresariales","Implementación de chatbots inteligentes","Análisis predictivo con IA","Capacitación personalizada","Consultoría especializada","Integración con sistemas existentes"]}];return st.jsx("section",{id:"servicios",className:"py-24 bg-gradient-to-b from-gray-50 to-white",children:st.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[st.jsxs("div",{className:"text-center mb-16",children:[st.jsxs("div",{className:"inline-flex items-center space-x-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-4",children:[st.jsx(zc,{className:"w-4 h-4"}),st.jsx("span",{children:"Nuestros Servicios"})]}),st.jsxs("h2",{className:"text-4xl md:text-5xl font-bold text-gray-900 mb-6",children:["Soluciones que"," ",st.jsx("span",{className:"bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent",children:"transforman"})]}),st.jsx("p",{className:"text-xl text-gray-600 max-w-3xl mx-auto",children:"Ofrecemos servicios especializados diseñados para impulsar tu negocio hacia el éxito digital"})]}),st.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:o.map((t,i)=>st.jsx(X1,{icon:t.icon,title:t.title,description:t.description,features:t.features,gradient:t.gradient,delay:i*100},i))})]})})},q1=({icon:o,title:t,description:i,gradient:r})=>{const l=o;return st.jsxs("div",{className:"group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100",children:[st.jsx("div",{className:`inline-flex items-center justify-center w-14 h-14 ${r} rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300`,children:st.jsx(l,{className:"w-7 h-7 text-white"})}),st.jsx("h3",{className:"text-xl font-bold text-gray-900 mb-3",children:t}),st.jsx("p",{className:"text-gray-600 leading-relaxed",children:i})]})},Y1=()=>{const o=[{icon:w1,title:"+20 años de experiencia",description:"Más de dos décadas brindando soluciones tecnológicas exitosas y transformando negocios.",gradient:"bg-gradient-to-br from-yellow-500 to-orange-600"},{icon:D1,title:"Soluciones personalizadas",description:"Cada cliente es único. Desarrollamos estrategias específicas adaptadas a tu industria y objetivos.",gradient:"bg-gradient-to-br from-blue-500 to-purple-600"},{icon:y1,title:"Consulta gratuita",description:"Presupuestos sin costo y asesoramiento inicial completamente gratuito para evaluar tu proyecto.",gradient:"bg-gradient-to-br from-green-500 to-teal-600"}];return st.jsx("section",{className:"py-24 bg-white",children:st.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:st.jsxs("div",{className:"grid lg:grid-cols-2 gap-16 items-center",children:[st.jsxs("div",{children:[st.jsxs("div",{className:"inline-flex items-center space-x-2 bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-medium mb-6",children:[st.jsx(O1,{className:"w-4 h-4"}),st.jsx("span",{children:"¿Por qué elegirnos?"})]}),st.jsxs("h2",{className:"text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight",children:["Experiencia que"," ",st.jsx("span",{className:"bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent",children:"transforma"})]}),st.jsxs("div",{className:"space-y-6 text-lg text-gray-600 leading-relaxed",children:[st.jsx("p",{children:"Somos una empresa familiar con más de 20 años de trayectoria exitosa, especializada en soluciones tecnológicas innovadoras para particulares, profesionales y pequeñas empresas."}),st.jsx("p",{children:"Nuestro enfoque principal es el marketing digital, ayudando a cientos de negocios a crecer exponencialmente y aumentar sus ventas a través de campañas publicitarias altamente efectivas y estrategias personalizadas."}),st.jsx("p",{children:"Combinamos experiencia, innovación y resultados garantizados para transformar tu presencia digital."})]}),st.jsxs("div",{className:"mt-8 flex items-center space-x-4",children:[st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx(k0,{className:"w-5 h-5 text-blue-600"}),st.jsx("span",{className:"text-gray-700 font-medium",children:"Respuesta en 24hs"})]}),st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx(V0,{className:"w-5 h-5 text-green-600"}),st.jsx("span",{className:"text-gray-700 font-medium",children:"Garantía total"})]})]})]}),st.jsx("div",{className:"grid gap-6",children:o.map((t,i)=>st.jsx(q1,{icon:t.icon,title:t.title,description:t.description,gradient:t.gradient},i))})]})})})},j1=()=>{const o=()=>{window.gtag&&window.gtag("event","conversion",{send_to:"AW-1029418216/rcu4CPmQ2O0aEOjZ7uoD"})};return st.jsx("footer",{className:"bg-gray-900 text-white",children:st.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16",children:[st.jsxs("div",{className:"grid md:grid-cols-2 lg:grid-cols-4 gap-8",children:[st.jsxs("div",{className:"lg:col-span-2",children:[st.jsxs("div",{className:"flex items-center space-x-2 mb-6",children:[st.jsx("div",{className:"w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center",children:st.jsx(zc,{className:"w-5 h-5 text-white"})}),st.jsx("span",{className:"text-xl font-bold",children:"TecnoSoluciones"})]}),st.jsx("p",{className:"text-gray-300 mb-6 max-w-md",children:"Transformando negocios desde 2004 con soluciones tecnológicas innovadoras y marketing digital efectivo."}),st.jsx("div",{className:"flex space-x-4",children:st.jsxs("a",{href:"https://wa.me/5491134227461",onClick:o,target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center space-x-2 bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg transition-colors",children:[st.jsx(Oo,{className:"w-4 h-4"}),st.jsx("span",{children:"WhatsApp"})]})})]}),st.jsxs("div",{children:[st.jsx("h3",{className:"text-lg font-semibold mb-4",children:"Contacto"}),st.jsxs("div",{className:"space-y-3 text-gray-300",children:[st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx(Oo,{className:"w-4 h-4"}),st.jsx("a",{href:"https://wa.me/5491134227461",onClick:o,target:"_blank",rel:"noopener noreferrer",className:"hover:text-green-400 transition-colors",children:"+54 11 3422 7461"})]}),st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx(hd,{className:"w-4 h-4"}),st.jsx("span",{children:"tecnosolucionesuno@gmail.com"})]}),st.jsxs("div",{className:"flex items-center space-x-2",children:[st.jsx(k0,{className:"w-4 h-4"}),st.jsx("span",{children:"Lunes a Viernes 9-18hs"})]})]})]}),st.jsxs("div",{children:[st.jsx("h3",{className:"text-lg font-semibold mb-4",children:"Servicios"}),st.jsxs("div",{className:"space-y-2 text-gray-300",children:[st.jsx("p",{children:"Marketing Digital Avanzado"}),st.jsx("p",{children:"Soporte Técnico Especializado"}),st.jsx("p",{children:"Inteligencia Artificial"}),st.jsx("p",{children:"Consultoría Tecnológica"})]})]})]}),st.jsx("div",{className:"border-t border-gray-800 mt-12 pt-8 text-center text-gray-400",children:st.jsx("p",{children:"© 2024 TecnoSoluciones. Todos los derechos reservados. | Transformando negocios desde 2004"})})]})})},Z1=()=>(vn.useEffect(()=>{F1(),window.gtag&&window.gtag("event","conversion",{send_to:"AW-1029418216/1AT6CPOQ2O0aEOjZ7uoD"})},[]),st.jsxs("div",{className:"min-h-screen",children:[st.jsx(V1,{}),st.jsx(k1,{}),st.jsx(W1,{}),st.jsx(Y1,{}),st.jsx(j1,{})]}));eS.createRoot(document.getElementById("root")).render(st.jsx(vn.StrictMode,{children:st.jsx(Z1,{})}));
